module single_cycle_cpu (clk,
 ...
 sky130_fd_sc_hd__o21a_2 _3299_ (.A1(net454),
    .A2(net456),
    .B1(net10),
    .X(_1251_));
 sky130_fd_sc_hd__inv_2 _3300_ (.A(net456),
    .Y(_1252_));
 sky130_fd_sc_hd__nand2_4 _3301_ (.A(net10),
    .B(net837),
    .Y(_1253_));
 sky130_fd_sc_hd__a21o_2 _3302_ (.A1(net454),
    .A2(net839),
    .B1(net10),
    .X(_1254_));
 sky130_fd_sc_hd__o21a_4 _3303_ (.A1(_1252_),
    ...
    .B1(_1254_),
    .X(\next_pc[4] ));
 sky130_fd_sc_hd__nand2_2 _3304_ (.A(net832),
    .B(net454),
    .Y(_1255_));
 sky130_fd_sc_hd__inv_2 _3305_ (.A(net830),
    .Y(_1256_));
 sky130_fd_sc_hd__o221a_2 _3306_ (.A1(net832),
    .A2(_1251_),
    .B1(\next_pc[4] ),
    .B2(_1255_),
    .C1(_1256_),
    .X(net872));
 sky130_fd_sc_hd__nand2_2 _3308_ (.A(net834),
    .B(net456),
    .Y(_1258_));
 ...
 sky130_fd_sc_hd__o21ai_2 _3311_ (.A1(_1258_),
    ...
    .B1(_1256_),
    .Y(_1261_));
 sky130_fd_sc_hd__a311o_2 _3312_ (.A1(net831),
    .A2(_1252_),
    .A3(_1253_),
    .B1(_1260_),
    .C1(_1261_),
    .X(_1262_));
 sky130_fd_sc_hd__nand4b_4 _3313_ (.A_N(net256),
    .B(net835),
    .C(net10),
    .D(net259),
    .Y(_1263_));
 sky130_fd_sc_hd__or2_2 _3314_ (.A(_1252_),
    .B(_1263_),
    .X(_1264_));
 sky130_fd_sc_hd__nor2b_2 _3316_ (.A(net836),
    .B_N(net829),
    .Y(_1266_));
 sky130_fd_sc_hd__nand2_2 _3318_ (.A(net838),
    .B(net827),
    .Y(_1268_));
 sky130_fd_sc_hd__and4b_4 _3319_ (.A_N(net872),
    .B(_1262_),
    .C(_1264_),
    .D(_1268_),
    .X(_1269_));
 sky130_fd_sc_hd__inv_2 _3320_ (.A(_1268_),
    .Y(net782));
 sky130_fd_sc_hd__or2_4 _3321_ (.A(net833),
    .B(net837),
    .X(_1270_));
 sky130_fd_sc_hd__a31o_2 _3323_ (.A1(net832),
    .A2(_1253_),
    .A3(_1270_),
    .B1(net839),
    .X(_1272_));
 sky130_fd_sc_hd__or3_2 _3324_ (.A(net10),
    .B(_1252_),
    .C(_1255_),
    .X(_1273_));
 sky130_fd_sc_hd__a21oi_2 _3325_ (.A1(_1272_),
    ...
    .B1(net830),
    .Y(_1274_));
 sky130_fd_sc_hd__nor2_2 _3326_ (.A(net782),
    .B(_1274_),
    .Y(_1275_));
 ...
 sky130_fd_sc_hd__nor2_2 _3328_ (.A(_1251_),
    .B(_1276_),
    .Y(_1277_));
 sky130_fd_sc_hd__nand2_2 _3329_ (.A(net831),
    .B(_1277_),
    .Y(_1278_));
 sky130_fd_sc_hd__inv_2 _3330_ (.A(net831),
    .Y(_1279_));
 ...
 sky130_fd_sc_hd__a211oi_4 _3339_ (.A1(_1269_),
    ...
    .C1(net771),
    .Y(_1287_));
 sky130_fd_sc_hd__and3_2 _3340_ (.A(net832),
    .B(_1256_),
    .C(_1277_),
    .X(_1288_));
 sky130_fd_sc_hd__inv_2 _3341_ (.A(_1281_),
    .Y(_1289_));
 sky130_fd_sc_hd__nand2b_4 _3342_ (.A_N(net256),
    .B(net259),
    .Y(_1290_));
 ...
 sky130_fd_sc_hd__or2_2 _3347_ (.A(_1288_),
    .B(net767),
    .X(_1294_));
 sky130_fd_sc_hd__a21oi_2 _3348_ (.A1(net833),
    .A2(net837),
    .B1(net832),
    .Y(_1295_));
 sky130_fd_sc_hd__nand2_2 _3349_ (.A(net832),
    .B(_1270_),
    .Y(_1296_));
 sky130_fd_sc_hd__nor2_2 _3350_ (.A(net839),
    .B(_1296_),
    .Y(_1297_));
 ...
 sky130_fd_sc_hd__nor2_2 _3352_ (.A(_1294_),
    .B(_1298_),
    .Y(_1299_));
 sky130_fd_sc_hd__xor2_2 _3353_ (.A(net837),
    .B(net839),
    .X(_1300_));
 sky130_fd_sc_hd__a211o_2 _3354_ (.A1(net833),
    .A2(_1300_),
    .B1(_1276_),
    .C1(net829),
    .X(_1301_));
 sky130_fd_sc_hd__o21ai_2 _3355_ (.A1(net833),
    .A2(_1300_),
    .B1(_1253_),
    .Y(_1302_));
 ...
 sky130_fd_sc_hd__inv_6 _3357_ (.A(_1303_),
    .Y(net883));
 sky130_fd_sc_hd__o211a_4 _3358_ (.A1(net943),
    .A2(_1299_),
    .B1(net883),
    .C1(net836),
    .X(_1304_));
 sky130_fd_sc_hd__or2_2 _3359_ (.A(net829),
    .B(_1295_),
    .X(_1305_));
 sky130_fd_sc_hd__mux2_2 _3360_ (.A0(net837),
    .A1(net839),
    .S(net833),
    .X(_1306_));
 sky130_fd_sc_hd__and2_2 _3361_ (.A(net259),
    .B(_1306_),
    .X(_1307_));
 sky130_fd_sc_hd__or3b_2 _3362_ (.A(net456),
    ...
    .C_N(net259),
    .X(_1308_));
 sky130_fd_sc_hd__or3b_4 _3363_ (.A(net259),
    .B(net829),
    .C_N(net456),
    .X(_1309_));
 sky130_fd_sc_hd__a21boi_2 _3364_ (.A1(_1308_),
    ...
    .B1_N(net833),
    .Y(_1310_));
 sky130_fd_sc_hd__inv_2 _3365_ (.A(net836),
    .Y(_1311_));
 sky130_fd_sc_hd__o211a_2 _3366_ (.A1(_1305_),
    ...
    .C1(_1311_),
    .X(_1312_));
 sky130_fd_sc_hd__a211oi_4 _3368_ (.A1(net831),
    .A2(_1270_),
    .B1(_1260_),
    .C1(net829),
    .Y(net238));
 sky130_fd_sc_hd__nand2_2 _3369_ (.A(net833),
    .B(_1300_),
    .Y(_1314_));
 sky130_fd_sc_hd__nor2_2 _3370_ (.A(net259),
    .B(net829),
    .Y(_1315_));
 sky130_fd_sc_hd__nor4bb_1 _3371_ (.A(net833),
    .B(_1290_),
    .C_N(_1311_),
    .D_N(net456),
    .Y(_1316_));
 ...
 sky130_fd_sc_hd__nor2_2 _3376_ (.A(_1305_),
    .B(_1307_),
    .Y(net576));
 sky130_fd_sc_hd__and4bb_4 _3377_ (.A_N(net778),
    .B_N(net877),
    .C(_1319_),
    .D(net576),
    .X(_1320_));
 sky130_fd_sc_hd__nor2_2 _3378_ (.A(net872),
    .B(_1262_),
    .Y(_1321_));
 ...
 sky130_fd_sc_hd__a22o_2 _3384_ (.A1(\RF.registers[11][4] ),
    ...
    .X(_1327_));
 sky130_fd_sc_hd__nor2_2 _3385_ (.A(net829),
    .B(_1295_),
    .Y(_1328_));
 sky130_fd_sc_hd__nand2_2 _3386_ (.A(net259),
    .B(_1306_),
    .Y(_1329_));
 sky130_fd_sc_hd__a211o_2 _3387_ (.A1(_1328_),
    ...
    .C1(_1310_),
    .X(_1330_));
 sky130_fd_sc_hd__nor2_1 _3388_ (.A(net778),
    .B(_1330_),
    .Y(_1331_));
 ...
 sky130_fd_sc_hd__a21oi_2 _3391_ (.A1(\RF.registers[9][4] ),
    ...
    .B1(_1333_),
    .Y(_1334_));
 sky130_fd_sc_hd__nor2_2 _3392_ (.A(net877),
    .B(_1330_),
    .Y(_1335_));
 sky130_fd_sc_hd__or2_2 _3394_ (.A(net778),
    .B(_1330_),
    .X(_1337_));
 sky130_fd_sc_hd__nor2_2 _3395_ (.A(\RF.registers[1][4] ),
    .B(_1337_),
    .Y(_1338_));
 sky130_fd_sc_hd__inv_2 _3398_ (.A(net793),
    .Y(_1341_));
 sky130_fd_sc_hd__nor2_4 _3399_ (.A(net948),
    .B(_1310_),
    .Y(_1342_));
 ...
 sky130_fd_sc_hd__a21oi_4 _3402_ (.A1(_1328_),
    ...
    .B1(_1266_),
    .Y(_1344_));
 sky130_fd_sc_hd__or2_4 _3403_ (.A(net838),
    .B(_1263_),
    .X(_1345_));
 sky130_fd_sc_hd__o31a_2 _3405_ (.A1(net831),
    .A2(net829),
    .A3(_1277_),
    .B1(_1345_),
    .X(_1347_));
 sky130_fd_sc_hd__inv_4 _3406_ (.A(_1347_),
    .Y(net882));
 sky130_fd_sc_hd__and3_2 _3407_ (.A(net881),
    .B(_1344_),
    .C(net882),
    .X(_1348_));
 sky130_fd_sc_hd__and4_2 _3409_ (.A(net883),
    .B(_1342_),
    .C(_1344_),
    .D(_1347_),
    .X(_1350_));
 ...
 sky130_fd_sc_hd__nand2b_2 _3427_ (.A_N(_1365_),
    .B(_1366_),
    .Y(_1367_));
 sky130_fd_sc_hd__or2_2 _3429_ (.A(net877),
    .B(_1330_),
    .X(_1369_));
 ...
 sky130_fd_sc_hd__a221o_2 _3448_ (.A1(\RF.registers[10][3] ),
    ...
    .C1(_1387_),
    .X(_1388_));
 sky130_fd_sc_hd__and3_2 _3449_ (.A(net883),
    .B(_1342_),
    .C(net884),
    .X(_1389_));
 ...
 sky130_fd_sc_hd__a221o_2 _3468_ (.A1(\RF.registers[10][2] ),
    ...
    .C1(_1407_),
    .X(_1408_));
 sky130_fd_sc_hd__nor2_2 _3469_ (.A(net943),
    .B(_1299_),
    .Y(_1409_));
 ...
 sky130_fd_sc_hd__o31a_2 _3484_ (.A1(_1382_),
    ...
    .B1(_1423_),
    .X(_1424_));
 sky130_fd_sc_hd__or3_4 _3485_ (.A(net942),
    .B(_1416_),
    .C(_1424_),
    .X(_1425_));
 sky130_fd_sc_hd__o21ai_2 _3486_ (.A1(net942),
    .A2(_1416_),
    .B1(_1424_),
    .Y(_1426_));
 sky130_fd_sc_hd__o2111a_2 _3487_ (.A1(net943),
    .A2(_1299_),
    .B1(net883),
    .C1(\RF.registers[9][0] ),
    .D1(net836),
 ...
 sky130_fd_sc_hd__a31oi_4 _3499_ (.A1(_1409_),
    ...
    .B1(_1438_),
    .Y(_1439_));
 sky130_fd_sc_hd__a21oi_2 _3500_ (.A1(net743),
    .A2(_1432_),
    .B1(_1439_),
    .Y(_1440_));
 sky130_fd_sc_hd__a21o_2 _3501_ (.A1(_1425_),
    ...
    .B1(_1440_),
    .X(_1441_));
 sky130_fd_sc_hd__or3b_2 _3502_ (.A(net942),
    .B(_1416_),
    .C_N(_1424_),
    .X(_1442_));
 ...
 sky130_fd_sc_hd__a21bo_2 _3517_ (.A1(_1306_),
    ...
    .B1_N(_1456_),
    .X(net875));
 sky130_fd_sc_hd__nor2_2 _3519_ (.A(net839),
    .B(_1253_),
    .Y(_1458_));
 sky130_fd_sc_hd__o2bb2a_2 _3520_ (.A1_N(_1290_),
    ...
    .B2(_1296_),
    .X(net876));
 sky130_fd_sc_hd__nand2_2 _3521_ (.A(net875),
    .B(net876),
    .Y(_1459_));
 ...
 sky130_fd_sc_hd__o311a_4 _3523_ (.A1(_1411_),
    ...
    .C1(_1367_),
    .X(_1461_));
 sky130_fd_sc_hd__and2_2 _3525_ (.A(net875),
    .B(net876),
    .X(_1463_));
 ...
 sky130_fd_sc_hd__or2_2 _3528_ (.A(_1280_),
    .B(_1290_),
    .X(_1466_));
 sky130_fd_sc_hd__a41o_2 _3532_ (.A1(net834),
    .A2(_1449_),
    .A3(_1298_),
    .A4(_1466_),
    .B1(net818),
 ...
 sky130_fd_sc_hd__nand2_2 _3539_ (.A(_1381_),
    .B(_1476_),
    .Y(_1477_));
 sky130_fd_sc_hd__o21a_2 _3540_ (.A1(net942),
    .A2(_1416_),
    .B1(_1424_),
    .X(_1478_));
 sky130_fd_sc_hd__or3b_4 _3541_ (.A(net760),
    .B(_1439_),
    .C_N(_1432_),
    .X(_1479_));
 ...
 sky130_fd_sc_hd__o311a_2 _3552_ (.A1(_1448_),
    ...
    .C1(_1489_),
    .X(_1490_));
 sky130_fd_sc_hd__o2111a_2 _3553_ (.A1(net943),
    .A2(_1299_),
    .B1(net883),
    .C1(\RF.registers[9][6] ),
    .D1(net836),
 ...
 sky130_fd_sc_hd__nor2_2 _3560_ (.A(_1290_),
    .B(_1314_),
    .Y(net204));
 sky130_fd_sc_hd__or3_2 _3561_ (.A(net832),
    .B(net829),
    .C(_1300_),
    .X(_1498_));
 ...
 sky130_fd_sc_hd__and2_2 _3564_ (.A(_1311_),
    .B(net897),
    .X(_1500_));
 sky130_fd_sc_hd__o211a_2 _3565_ (.A1(net943),
    .A2(_1299_),
    .B1(_1500_),
    .C1(net883),
    .X(_1501_));
 ...
 sky130_fd_sc_hd__a2111o_2 _3570_ (.A1(\RF.registers[4][6] ),
    ...
    .D1(net943),
    .X(_1506_));
 sky130_fd_sc_hd__o32a_2 _3571_ (.A1(net888),
    .A2(_1363_),
    .A3(_1501_),
    .B1(_1505_),
    .B2(_1506_),
 ...
 sky130_fd_sc_hd__nor2_2 _3589_ (.A(_1334_),
    .B(_1338_),
    .Y(_1525_));
 sky130_fd_sc_hd__and3_2 _3590_ (.A(net743),
    .B(_1525_),
    .C(_1364_),
    .X(_1526_));
 ...
 sky130_fd_sc_hd__nor2_2 _3599_ (.A(_1521_),
    .B(net690),
    .Y(_1535_));
 sky130_fd_sc_hd__inv_2 _3600_ (.A(net690),
    .Y(_1536_));
 ...
 sky130_fd_sc_hd__nand2_2 _3607_ (.A(_1497_),
    .B(_1507_),
    .Y(_1543_));
 sky130_fd_sc_hd__nand2_2 _3609_ (.A(net697),
    .B(net741),
    .Y(_1545_));
 ...
 sky130_fd_sc_hd__and3_2 _3627_ (.A(_1490_),
    ...
    .C(_1562_),
    .X(_1563_));
 sky130_fd_sc_hd__inv_2 _3629_ (.A(net649),
    .Y(_1565_));
 ...
 sky130_fd_sc_hd__a21o_2 _3645_ (.A1(\RF.registers[13][31] ),
    ...
    .B1(_1578_),
    .X(_1117_));
 sky130_fd_sc_hd__inv_2 _3650_ (.A(net682),
    .Y(_1583_));
 sky130_fd_sc_hd__nor2_2 _3651_ (.A(_1583_),
    .B(net681),
    .Y(_1584_));
 sky130_fd_sc_hd__nor2_2 _3656_ (.A(net682),
    .B(net681),
    .Y(_1589_));
 sky130_fd_sc_hd__and2_4 _3661_ (.A(net682),
    .B(net681),
    .X(_1594_));
 ...
 sky130_fd_sc_hd__a221o_2 _3669_ (.A1(\DMEM.memory[1][30] ),
    ...
    .C1(_1601_),
    .X(_1602_));
 sky130_fd_sc_hd__a21o_2 _3670_ (.A1(net649),
    .A2(_1602_),
    .B1(net737),
    .X(_1603_));
 ...
 sky130_fd_sc_hd__a221o_2 _3681_ (.A1(_1606_),
    ...
    .C1(_1612_),
    .X(_1613_));
 sky130_fd_sc_hd__nand2_2 _3682_ (.A(net649),
    .B(_1613_),
    .Y(_1614_));
 ...
 sky130_fd_sc_hd__a221o_2 _3696_ (.A1(\DMEM.memory[3][27] ),
    ...
    .C1(_1625_),
    .X(_1626_));
 sky130_fd_sc_hd__a21oi_2 _3697_ (.A1(net649),
    .A2(_1626_),
    .B1(net737),
    .Y(_1627_));
 ...
 sky130_fd_sc_hd__a221o_2 _3700_ (.A1(\DMEM.memory[3][26] ),
    ...
    .C1(_1628_),
    .X(_1629_));
 sky130_fd_sc_hd__a21o_2 _3701_ (.A1(net649),
    .A2(_1629_),
    .B1(net737),
    .X(_1630_));
 ...
 sky130_fd_sc_hd__a221o_2 _3708_ (.A1(\DMEM.memory[1][24] ),
    ...
    .C1(_1634_),
    .X(_1635_));
 sky130_fd_sc_hd__a21o_2 _3709_ (.A1(net649),
    .A2(_1635_),
    .B1(net737),
    .X(_1636_));
 ...
 sky130_fd_sc_hd__inv_4 _3713_ (.A(_1562_),
    .Y(net867));
 sky130_fd_sc_hd__and3_2 _3714_ (.A(net866),
    .B(net868),
    .C(net867),
    .X(_1637_));
 ...
 sky130_fd_sc_hd__a221o_2 _3724_ (.A1(\DMEM.memory[23][23] ),
    ...
    .C1(_1646_),
    .X(_1647_));
 sky130_fd_sc_hd__and3_2 _3725_ (.A(net866),
    .B(net868),
    .C(_1562_),
    .X(_1648_));
 ...
 sky130_fd_sc_hd__a22o_2 _3734_ (.A1(_1651_),
    ...
    .B2(_1656_),
    .X(_1657_));
 sky130_fd_sc_hd__and3_4 _3735_ (.A(net866),
    .B(_1550_),
    .C(net867),
    .X(_1658_));
 ...
 sky130_fd_sc_hd__a221o_2 _3752_ (.A1(\DMEM.memory[1][22] ),
    ...
    .C1(_1673_),
    .X(_1674_));
 sky130_fd_sc_hd__a21o_2 _3753_ (.A1(net649),
    .A2(_1674_),
    .B1(net737),
    .X(_1675_));
 ...
 sky130_fd_sc_hd__a22o_2 _3760_ (.A1(\DMEM.memory[3][20] ),
    ...
    .B2(\DMEM.memory[0][20] ),
    .X(_1680_));
 sky130_fd_sc_hd__o31a_2 _3762_ (.A1(net867),
    .A2(_1679_),
    .A3(_1680_),
    .B1(net732),
    .X(_1682_));
 ...
 sky130_fd_sc_hd__a22o_2 _3768_ (.A1(\DMEM.memory[3][18] ),
    ...
    .B2(\DMEM.memory[1][18] ),
    .X(_1686_));
 sky130_fd_sc_hd__o31a_2 _3769_ (.A1(net867),
    .A2(_1685_),
    .A3(_1686_),
    .B1(net734),
    .X(_1687_));
 ...
 sky130_fd_sc_hd__a221o_2 _3810_ (.A1(\DMEM.memory[27][16] ),
    ...
    .C1(_1725_),
    .X(_1726_));
 sky130_fd_sc_hd__a22o_2 _3811_ (.A1(_1563_),
    .A2(_1724_),
    .B1(_1726_),
    .B2(_1664_),
    .X(_1727_));
 ...
 sky130_fd_sc_hd__a221o_2 _3816_ (.A1(\DMEM.memory[1][15] ),
    ...
    .C1(_1730_),
    .X(_1731_));
 sky130_fd_sc_hd__a21o_2 _3817_ (.A1(net649),
    .A2(_1731_),
    .B1(net737),
    .X(_1732_));
 ...
 sky130_fd_sc_hd__a22o_2 _3820_ (.A1(\DMEM.memory[3][14] ),
    ...
    .B2(\DMEM.memory[0][14] ),
    .X(_1734_));
 sky130_fd_sc_hd__o31a_2 _3821_ (.A1(net867),
    .A2(_1733_),
    .A3(_1734_),
    .B1(net734),
    .X(_1735_));
 ...
 sky130_fd_sc_hd__a221o_2 _3830_ (.A1(\DMEM.memory[29][13] ),
    ...
    .C1(_1742_),
    .X(_1743_));
 sky130_fd_sc_hd__a22o_2 _3831_ (.A1(net649),
    .A2(_1741_),
    .B1(_1743_),
    .B2(_1637_),
    .X(_1744_));
 ...
 sky130_fd_sc_hd__a22o_2 _3873_ (.A1(_1656_),
    ...
    .B2(net650),
    .X(_1781_));
 sky130_fd_sc_hd__or2_2 _3874_ (.A(net737),
    .B(_1781_),
    .X(_1782_));
 ...
 sky130_fd_sc_hd__a22o_2 _3894_ (.A1(_1651_),
    ...
    .B2(_1656_),
    .X(_1801_));
 sky130_fd_sc_hd__a221o_2 _3895_ (.A1(_1563_),
    .A2(_1794_),
    .B1(_1796_),
    .B2(_1664_),
    .C1(_1801_),
 ...
 sky130_fd_sc_hd__a221o_2 _3903_ (.A1(\DMEM.memory[1][5] ),
    ...
    .C1(_1807_),
    .X(_1808_));
 sky130_fd_sc_hd__nand2_2 _3904_ (.A(net735),
    .B(_1808_),
    .Y(_1809_));
 ...
 sky130_fd_sc_hd__a221o_2 _3913_ (.A1(\DMEM.memory[29][3] ),
    ...
    .C1(_1815_),
    .X(_1816_));
 sky130_fd_sc_hd__a22o_2 _3914_ (.A1(net650),
    .A2(_1814_),
    .B1(_1816_),
    .B2(_1637_),
    .X(_1817_));
 ...
 sky130_fd_sc_hd__a221o_2 _3918_ (.A1(\DMEM.memory[3][2] ),
    ...
    .C1(_1819_),
    .X(_1820_));
 sky130_fd_sc_hd__a21o_2 _3919_ (.A1(net650),
    .A2(_1820_),
    .B1(net738),
    .X(_1821_));
 ...
 sky130_fd_sc_hd__a221o_2 _3922_ (.A1(\DMEM.memory[1][1] ),
    ...
    .C1(_1822_),
    .X(_1823_));
 sky130_fd_sc_hd__a21o_2 _3923_ (.A1(net650),
    .A2(_1823_),
    .B1(net738),
    .X(_1824_));
 ...
 sky130_fd_sc_hd__a221o_2 _3926_ (.A1(\DMEM.memory[3][0] ),
    ...
    .C1(_1825_),
    .X(_1826_));
 sky130_fd_sc_hd__a21o_2 _3927_ (.A1(net650),
    .A2(_1826_),
    .B1(net738),
    .X(_1827_));
 ...
 sky130_fd_sc_hd__mux2_2 _3989_ (.A0(\RF.registers[12][3] ),
    ...
    .S(net807),
    .X(_1860_));
 sky130_fd_sc_hd__or2_2 _3991_ (.A(net734),
    .B(net682),
    .X(_1861_));
 sky130_fd_sc_hd__nand2_2 _3992_ (.A(net821),
    .B(net823),
    .Y(_1862_));
 ...
 sky130_fd_sc_hd__or3b_2 _4108_ (.A(_1382_),
    ...
    .C_N(_1975_),
    .X(_1976_));
 sky130_fd_sc_hd__o31a_2 _4109_ (.A1(net760),
    .A2(_1969_),
    .A3(_1970_),
    .B1(_1976_),
    .X(_1977_));
 sky130_fd_sc_hd__or4_4 _4110_ (.A(net760),
    .B(_1969_),
    .C(_1970_),
    .D(_1976_),
    .X(_1978_));
 ...
 sky130_fd_sc_hd__or2_2 _4116_ (.A(\RF.registers[1][21] ),
    .B(net758),
    .X(_1984_));
 sky130_fd_sc_hd__nand3_2 _4117_ (.A(net745),
    .B(_1983_),
    .C(_1984_),
    .Y(_1985_));
 ...
 sky130_fd_sc_hd__and2b_2 _4124_ (.A_N(_1985_),
    .B(_1991_),
    .X(_1992_));
 sky130_fd_sc_hd__a31o_2 _4125_ (.A1(net745),
    .A2(_1983_),
    .A3(_1984_),
    .B1(_1991_),
    .X(_1993_));
 ...
 sky130_fd_sc_hd__nor2_2 _4141_ (.A(_1969_),
    .B(_1970_),
    .Y(_2009_));
 sky130_fd_sc_hd__and3_2 _4142_ (.A(net745),
    .B(_2009_),
    .C(_1976_),
    .X(_2010_));
 ...
 sky130_fd_sc_hd__o22a_2 _4148_ (.A1(\RF.registers[1][19] ),
    ...
    .B2(_2015_),
    .X(_2016_));
 sky130_fd_sc_hd__nand2_2 _4149_ (.A(net745),
    .B(_2016_),
    .Y(_2017_));
 ...
 sky130_fd_sc_hd__nand2_2 _4199_ (.A(_2060_),
    .B(_2066_),
    .Y(_2067_));
 sky130_fd_sc_hd__or2_2 _4200_ (.A(net683),
    .B(_2067_),
    .X(_2068_));
 ...
 sky130_fd_sc_hd__o21bai_2 _4204_ (.A1(_2040_),
    ...
    .B1_N(_2071_),
    .Y(_2072_));
 sky130_fd_sc_hd__and3_2 _4205_ (.A(net745),
    .B(_2016_),
    .C(_2023_),
    .X(_2073_));
 ...
 sky130_fd_sc_hd__o21a_2 _4216_ (.A1(\RF.registers[1][13] ),
    ...
    .B1(net743),
    .X(_2084_));
 sky130_fd_sc_hd__o2111a_2 _4217_ (.A1(net943),
    .A2(_1299_),
    .B1(net883),
 ...
 sky130_fd_sc_hd__a221o_2 _4247_ (.A1(\RF.registers[9][14] ),
    ...
    .C1(_2114_),
    .X(_2115_));
 sky130_fd_sc_hd__or3_4 _4248_ (.A(net763),
    .B(_2113_),
    .C(_2115_),
    .X(_2116_));
 ...
 sky130_fd_sc_hd__or3b_2 _4272_ (.A(_1382_),
    ...
    .C_N(_2139_),
    .X(_2140_));
 sky130_fd_sc_hd__nor4_1 _4273_ (.A(net760),
    .B(_2132_),
    .C(_2133_),
    .D(_2140_),
    .Y(_2141_));
 sky130_fd_sc_hd__o31ai_2 _4274_ (.A1(net760),
    .A2(_2132_),
    .A3(_2133_),
    .B1(_2140_),
    .Y(_2142_));
 sky130_fd_sc_hd__nor2b_2 _4275_ (.A(net939),
    .B_N(_2142_),
    .Y(_2143_));
 ...
 sky130_fd_sc_hd__a2bb2o_4 _4290_ (.A1_N(_2151_),
    ...
    .B2(_2157_),
    .X(_2158_));
 sky130_fd_sc_hd__xnor2_2 _4291_ (.A(net688),
    .B(_2158_),
    .Y(_2159_));
 sky130_fd_sc_hd__and3_2 _4292_ (.A(_1508_),
    ...
    .C(_2159_),
    .X(_2160_));
 sky130_fd_sc_hd__and2b_2 _4293_ (.A_N(net688),
    .B(_2158_),
    .X(_2161_));
 sky130_fd_sc_hd__xor2_2 _4294_ (.A(net688),
    .B(_2158_),
    .X(_2162_));
 ...
 sky130_fd_sc_hd__or3b_2 _4312_ (.A(_1382_),
    ...
    .C_N(_2179_),
    .X(_2180_));
 sky130_fd_sc_hd__or4_4 _4313_ (.A(net760),
    .B(_2172_),
    .C(_2173_),
    .D(_2180_),
    .X(_2181_));
 sky130_fd_sc_hd__o31ai_2 _4314_ (.A1(net760),
    .A2(_2172_),
    .A3(_2173_),
    .B1(_2180_),
    .Y(_2182_));
 ...
 sky130_fd_sc_hd__a211o_2 _4326_ (.A1(\RF.registers[15][11] ),
    ...
    .C1(_2193_),
    .X(_2194_));
 sky130_fd_sc_hd__nand2_2 _4327_ (.A(net699),
    .B(_2194_),
    .Y(_2195_));
 ...
 sky130_fd_sc_hd__and3_2 _4365_ (.A(_2209_),
    ...
    .C(_2205_),
    .X(_2233_));
 sky130_fd_sc_hd__a32o_2 _4366_ (.A1(net743),
    .A2(_2232_),
    .A3(_2180_),
    .B1(_2183_),
    .B2(_2233_),
 ...
 sky130_fd_sc_hd__o21ba_2 _4375_ (.A1(_2126_),
    ...
    .B1_N(_2124_),
    .X(_2243_));
 sky130_fd_sc_hd__or4b_2 _4376_ (.A(net760),
    .B(_2132_),
    .C(_2133_),
    .D_N(_2140_),
    .X(_2244_));
 ...
 sky130_fd_sc_hd__nand2_2 _4381_ (.A(_2067_),
    .B(_2248_),
    .Y(_2249_));
 sky130_fd_sc_hd__nor2_2 _4382_ (.A(net683),
    .B(_2249_),
    .Y(_2250_));
 ...
 sky130_fd_sc_hd__a211o_2 _4408_ (.A1(\RF.registers[15][27] ),
    ...
    .C1(_2275_),
    .X(_2276_));
 sky130_fd_sc_hd__nand2_2 _4409_ (.A(net698),
    .B(_2276_),
    .Y(_2277_));
 ...
 sky130_fd_sc_hd__o211ai_2 _4423_ (.A1(\RF.registers[1][25] ),
    ...
    .C1(_2290_),
    .Y(_2291_));
 sky130_fd_sc_hd__a21oi_2 _4424_ (.A1(net698),
    .A2(_2286_),
    .B1(_2291_),
    .Y(_2292_));
 sky130_fd_sc_hd__and3_2 _4425_ (.A(net698),
    .B(_2291_),
    .C(_2286_),
    .X(_2293_));
 ...
 sky130_fd_sc_hd__nor2_2 _4446_ (.A(_2292_),
    .B(_2313_),
    .Y(_2314_));
 sky130_fd_sc_hd__nor2_2 _4447_ (.A(net934),
    .B(_2314_),
    .Y(_2315_));
 ...
 sky130_fd_sc_hd__a211o_2 _4454_ (.A1(_2311_),
    ...
    .C1(_2321_),
    .X(_2322_));
 sky130_fd_sc_hd__o211a_2 _4455_ (.A1(net935),
    .A2(_1949_),
    .B1(_1950_),
    .C1(_2322_),
    .X(_2323_));
 ...
 sky130_fd_sc_hd__o211a_2 _4459_ (.A1(_1908_),
    ...
    .C1(net768),
    .X(_2327_));
 sky130_fd_sc_hd__nand2_2 _4460_ (.A(net743),
    .B(_1432_),
    .Y(_2328_));
 ...
 sky130_fd_sc_hd__nor2_2 _4465_ (.A(_2327_),
    .B(_2332_),
    .Y(_2333_));
 sky130_fd_sc_hd__nand2_2 _4466_ (.A(net738),
    .B(_2333_),
    .Y(_2334_));
 sky130_fd_sc_hd__nor2_2 _4467_ (.A(_1252_),
    .B(_1263_),
    .Y(_2335_));
 sky130_fd_sc_hd__o21a_2 _4468_ (.A1(net899),
    .A2(_1438_),
    .B1(net783),
    .X(_2336_));
 sky130_fd_sc_hd__a31o_2 _4469_ (.A1(net899),
    .A2(_1252_),
    .A3(net827),
    .B1(_2336_),
    .X(_2337_));
 ...
 sky130_fd_sc_hd__inv_2 _4604_ (.A(_1345_),
    .Y(net889));
 sky130_fd_sc_hd__nor2_2 _4606_ (.A(net781),
    .B(net777),
    .Y(_2408_));
 sky130_fd_sc_hd__nor2_2 _4608_ (.A(_1455_),
    .B(_1906_),
    .Y(_2410_));
 sky130_fd_sc_hd__nand2_2 _4610_ (.A(net935),
    .B(_2321_),
    .Y(_2412_));
 sky130_fd_sc_hd__inv_2 _4611_ (.A(_2412_),
    .Y(_2413_));
 sky130_fd_sc_hd__nor2_2 _4612_ (.A(net688),
    .B(_2158_),
    .Y(_2414_));
 ...
 sky130_fd_sc_hd__and4_4 _4614_ (.A(_1465_),
    ...
    .D(_2162_),
    .X(_2416_));
 sky130_fd_sc_hd__a21oi_2 _4615_ (.A1(net688),
    .A2(_2158_),
    .B1(_1543_),
    .Y(_2417_));
 ...
 sky130_fd_sc_hd__and3b_2 _4637_ (.A_N(_2066_),
    ...
    .C(_2059_),
    .X(_2439_));
 sky130_fd_sc_hd__and2_2 _4638_ (.A(net683),
    .B(_2439_),
    .X(_2440_));
 ...
 sky130_fd_sc_hd__a211o_2 _4654_ (.A1(_2448_),
    ...
    .C1(_2278_),
    .X(_2456_));
 sky130_fd_sc_hd__a221o_2 _4655_ (.A1(net935),
    .A2(_2319_),
    .B1(_2413_),
    .B2(_2456_),
    .C1(_1935_),
 ...
 sky130_fd_sc_hd__nand2_2 _4658_ (.A(_1922_),
    .B(_2459_),
    .Y(_2460_));
 sky130_fd_sc_hd__o2111a_2 _4659_ (.A1(net692),
    .A2(_2325_),
    .B1(_2460_),
    .C1(_1557_),
    .D1(_1908_),
 ...
 sky130_fd_sc_hd__a21bo_2 _4660_ (.A1(_1923_),
    ...
    .B1_N(_1922_),
    .X(_2462_));
 sky130_fd_sc_hd__a221oi_2 _4662_ (.A1(net689),
    .A2(_2325_),
    .B1(_2462_),
    .B2(net686),
    .C1(_1908_),
    .Y(_2464_));
 sky130_fd_sc_hd__o32a_2 _4663_ (.A1(net742),
    .A2(_1907_),
    .A3(_2410_),
    .B1(_2461_),
    .B2(_2464_),
    .X(_2465_));
 sky130_fd_sc_hd__or3b_4 _4664_ (.A(net785),
    .B(_1578_),
    .C_N(_2465_),
    .X(_2466_));
 sky130_fd_sc_hd__or2_2 _4665_ (.A(net919),
    .B(net776),
    .X(_2467_));
 sky130_fd_sc_hd__xnor2_2 _4666_ (.A(net911),
    .B(net787),
    .Y(_2468_));
 sky130_fd_sc_hd__xnor2_2 _4667_ (.A(net912),
    .B(net787),
    .Y(_2469_));
 sky130_fd_sc_hd__and2_2 _4668_ (.A(_2468_),
    .B(_2469_),
    .X(_2470_));
 sky130_fd_sc_hd__and2_2 _4669_ (.A(net908),
    .B(net776),
    .X(_2471_));
 sky130_fd_sc_hd__or2_2 _4670_ (.A(net908),
    .B(net776),
    .X(_2472_));
 sky130_fd_sc_hd__and2_2 _4671_ (.A(net904),
    .B(net889),
    .X(_2473_));
 sky130_fd_sc_hd__nor2_2 _4672_ (.A(net904),
    .B(net776),
    .Y(_2474_));
 sky130_fd_sc_hd__or2_2 _4673_ (.A(_2473_),
    .B(_2474_),
    .X(_2475_));
 sky130_fd_sc_hd__or2_2 _4674_ (.A(net902),
    .B(net819),
    .X(_2476_));
 sky130_fd_sc_hd__o2111a_2 _4675_ (.A1(_1287_),
    ...
    .D1(net928),
    .X(_2477_));
 sky130_fd_sc_hd__o2111a_2 _4676_ (.A1(net888),
    .A2(_2477_),
    .B1(net929),
    .C1(net930),
    .D1(net900),
    .X(_2478_));
 sky130_fd_sc_hd__and2_2 _4677_ (.A(net902),
    .B(net819),
    .X(_2479_));
 sky130_fd_sc_hd__a31o_2 _4678_ (.A1(net901),
    .A2(_2476_),
    .A3(_2478_),
    .B1(_2479_),
    .X(_2480_));
 sky130_fd_sc_hd__nand2_2 _4679_ (.A(net903),
    .B(_2480_),
    .Y(_2481_));
 ...
 sky130_fd_sc_hd__and3b_2 _4682_ (.A_N(_2471_),
    ...
    .C(_2483_),
    .X(_2484_));
 sky130_fd_sc_hd__o21a_2 _4683_ (.A1(net911),
    .A2(net912),
    .B1(net776),
    .X(_2485_));
 sky130_fd_sc_hd__a31o_2 _4684_ (.A1(net909),
    .A2(_2470_),
    .A3(_2484_),
    .B1(_2485_),
    .X(_2486_));
 sky130_fd_sc_hd__a31o_2 _4685_ (.A1(net909),
    .A2(_2470_),
    .A3(_2471_),
    .B1(_2486_),
    .X(_2487_));
 sky130_fd_sc_hd__and3_2 _4686_ (.A(net913),
    .B(net914),
    .C(_2487_),
    .X(_2488_));
 sky130_fd_sc_hd__and2_2 _4687_ (.A(net915),
    .B(_2488_),
    .X(_2489_));
 sky130_fd_sc_hd__a31o_2 _4688_ (.A1(net915),
    .A2(net916),
    .A3(_2488_),
    .B1(net776),
    .X(_2490_));
 sky130_fd_sc_hd__o211a_2 _4689_ (.A1(net916),
    .A2(_2489_),
    .B1(_2490_),
    .C1(net917),
    .X(_2491_));
 sky130_fd_sc_hd__and2_2 _4690_ (.A(net919),
    .B(net776),
    .X(_2492_));
 sky130_fd_sc_hd__a31o_2 _4691_ (.A1(net918),
    .A2(_2467_),
    .A3(_2491_),
    .B1(_2492_),
    .X(_2493_));
 sky130_fd_sc_hd__and2_2 _4692_ (.A(net920),
    .B(_2493_),
    .X(_2494_));
 sky130_fd_sc_hd__nand2_2 _4693_ (.A(net922),
    .B(_2494_),
    .Y(_2495_));
 sky130_fd_sc_hd__nor2_2 _4694_ (.A(net923),
    .B(_2495_),
    .Y(_2496_));
 sky130_fd_sc_hd__a211o_2 _4695_ (.A1(net923),
    .A2(_2495_),
    .B1(_2496_),
    .C1(_1264_),
    .X(_2497_));
 sky130_fd_sc_hd__nor2_2 _4696_ (.A(_1258_),
    .B(_1255_),
    .Y(_2498_));
 sky130_fd_sc_hd__and3_2 _4697_ (.A(net830),
    .B(net928),
    .C(_2498_),
    .X(_2499_));
 sky130_fd_sc_hd__and2_2 _4698_ (.A(net929),
    .B(_2499_),
    .X(_2500_));
 sky130_fd_sc_hd__and3_2 _4699_ (.A(net930),
    .B(net900),
    .C(_2500_),
    .X(_2501_));
 sky130_fd_sc_hd__and2_2 _4700_ (.A(net901),
    .B(_2501_),
    .X(_2502_));
 sky130_fd_sc_hd__and3_2 _4701_ (.A(net902),
    .B(net903),
    .C(_2502_),
    .X(_2503_));
 sky130_fd_sc_hd__and2_2 _4702_ (.A(net904),
    .B(_2503_),
    .X(_2504_));
 sky130_fd_sc_hd__and3_2 _4703_ (.A(net905),
    .B(net906),
    .C(_2504_),
    .X(_2505_));
 sky130_fd_sc_hd__and2_2 _4704_ (.A(net907),
    .B(_2505_),
    .X(_2506_));
 sky130_fd_sc_hd__and3_2 _4705_ (.A(net908),
    .B(net909),
    .C(_2506_),
    .X(_2507_));
 sky130_fd_sc_hd__and2_2 _4706_ (.A(net911),
    .B(_2507_),
    .X(_2508_));
 sky130_fd_sc_hd__and4_2 _4707_ (.A(net912),
    .B(net913),
    .C(net914),
    .D(_2508_),
    .X(_2509_));
 sky130_fd_sc_hd__and2_2 _4708_ (.A(net915),
    .B(_2509_),
    .X(_2510_));
 sky130_fd_sc_hd__and3_2 _4709_ (.A(net916),
    .B(net917),
    .C(_2510_),
    .X(_2511_));
 sky130_fd_sc_hd__and2_2 _4710_ (.A(net918),
    .B(_2511_),
    .X(_2512_));
 sky130_fd_sc_hd__and3_2 _4711_ (.A(net919),
    .B(net920),
    .C(_2512_),
    .X(_2513_));
 sky130_fd_sc_hd__nand2_2 _4712_ (.A(net922),
    .B(_2513_),
    .Y(_2514_));
 sky130_fd_sc_hd__xnor2_2 _4713_ (.A(net923),
    .B(_2514_),
    .Y(\next_pc[31] ));
 sky130_fd_sc_hd__a32o_2 _4716_ (.A1(net739),
    .A2(_2466_),
    .A3(_2497_),
    .B1(\next_pc[31] ),
    .B2(net779),
 ...
 sky130_fd_sc_hd__xor2_2 _4720_ (.A(_1923_),
    .B(_2323_),
    .X(_2519_));
 sky130_fd_sc_hd__a21oi_2 _4721_ (.A1(net697),
    .A2(_1922_),
    .B1(_1921_),
    .Y(_2520_));
 ...
 sky130_fd_sc_hd__o21a_2 _4724_ (.A1(_1923_),
    ...
    .B1(_2459_),
    .X(_2523_));
 sky130_fd_sc_hd__a211o_2 _4725_ (.A1(net689),
    .A2(_2519_),
    .B1(_2522_),
    .C1(_2523_),
    .X(net863));
 sky130_fd_sc_hd__o211a_2 _4726_ (.A1(net732),
    .A2(net863),
    .B1(_1603_),
    .C1(_1263_),
    .X(_2524_));
 sky130_fd_sc_hd__o21a_2 _4727_ (.A1(net922),
    .A2(_2494_),
    .B1(net785),
    .X(_2525_));
 sky130_fd_sc_hd__nand2_2 _4728_ (.A(_2495_),
    .B(_2525_),
    .Y(_2526_));
 sky130_fd_sc_hd__nand2_2 _4729_ (.A(net820),
    .B(_2526_),
    .Y(_2527_));
 sky130_fd_sc_hd__or2_2 _4730_ (.A(net922),
    .B(_2513_),
    .X(_2528_));
 ...
 sky130_fd_sc_hd__mux2_2 _4735_ (.A0(\RF.registers[9][30] ),
    ...
    .S(net751),
    .X(_2532_));
 sky130_fd_sc_hd__a21oi_2 _4737_ (.A1(net919),
    .A2(_2512_),
    .B1(net920),
    .Y(_2533_));
 ...
 sky130_fd_sc_hd__a211oi_2 _4739_ (.A1(_2456_),
    ...
    .C1(net935),
    .Y(_2534_));
 sky130_fd_sc_hd__a221o_2 _4740_ (.A1(net935),
    .A2(_2319_),
    .B1(_2413_),
    .B2(_2456_),
    .C1(net691),
 ...
 sky130_fd_sc_hd__a21o_2 _4741_ (.A1(_2311_),
    ...
    .B1(_2321_),
    .X(_2536_));
 sky130_fd_sc_hd__o211ai_2 _4742_ (.A1(net935),
    .A2(_1949_),
    .B1(_2322_),
    .C1(net689),
    .Y(_2537_));
 sky130_fd_sc_hd__a31o_2 _4743_ (.A1(net935),
    .A2(_1949_),
    .A3(_2536_),
    .B1(_2537_),
    .X(_2538_));
 ...
 sky130_fd_sc_hd__inv_2 _4745_ (.A(_1937_),
    .Y(_2540_));
 sky130_fd_sc_hd__o32a_2 _4746_ (.A1(net742),
    .A2(_1936_),
    .A3(_2539_),
    .B1(_2540_),
    .B2(_1557_),
 ...
 sky130_fd_sc_hd__a21o_2 _4748_ (.A1(_1615_),
    ...
    .B1(net890),
    .X(_2543_));
 sky130_fd_sc_hd__nor2_2 _4749_ (.A(net920),
    .B(_2493_),
    .Y(_2544_));
 ...
 sky130_fd_sc_hd__nand2_2 _4751_ (.A(_2543_),
    .B(_2545_),
    .Y(_2546_));
 sky130_fd_sc_hd__a21o_2 _4752_ (.A1(net779),
    .A2(\next_pc[29] ),
    .B1(_2546_),
    .X(_2547_));
 sky130_fd_sc_hd__mux2_2 _4753_ (.A0(\RF.registers[9][29] ),
    ...
    .S(net751),
    .X(_2548_));
 sky130_fd_sc_hd__xor2_2 _4755_ (.A(net919),
    .B(_2512_),
    .X(\next_pc[28] ));
 sky130_fd_sc_hd__or2b_2 _4757_ (.A(_2492_),
    .B_N(_2467_),
    .X(_2550_));
 sky130_fd_sc_hd__nand2_2 _4758_ (.A(net918),
    .B(_2491_),
    .Y(_2551_));
 sky130_fd_sc_hd__xnor2_2 _4759_ (.A(_2550_),
    .B(_2551_),
    .Y(_2552_));
 sky130_fd_sc_hd__nand2_2 _4760_ (.A(net785),
    .B(_2552_),
    .Y(_2553_));
 ...
 sky130_fd_sc_hd__o21ai_2 _4768_ (.A1(_2555_),
    ...
    .B1(_2560_),
    .Y(_2561_));
 sky130_fd_sc_hd__a31o_2 _4769_ (.A1(net689),
    .A2(_2536_),
    .A3(_2554_),
    .B1(_2561_),
    .X(net860));
 sky130_fd_sc_hd__a211o_2 _4770_ (.A1(net732),
    .A2(_1623_),
    .B1(net860),
    .C1(net890),
    .X(_2562_));
 sky130_fd_sc_hd__o211a_2 _4771_ (.A1(net820),
    .A2(\next_pc[28] ),
    .B1(_2553_),
    .C1(_2562_),
    .X(_2563_));
 sky130_fd_sc_hd__mux2_2 _4772_ (.A0(\RF.registers[9][28] ),
    ...
    .S(net751),
    .X(_2564_));
 sky130_fd_sc_hd__nor2_2 _4774_ (.A(net918),
    .B(_2511_),
    .Y(_2565_));
 sky130_fd_sc_hd__nor2_2 _4775_ (.A(_2512_),
    .B(_2565_),
    .Y(\next_pc[27] ));
 sky130_fd_sc_hd__or2_2 _4776_ (.A(net918),
    .B(_2491_),
    .X(_2566_));
 sky130_fd_sc_hd__and3_2 _4777_ (.A(net785),
    .B(_2551_),
    .C(_2566_),
    .X(_2567_));
 ...
 sky130_fd_sc_hd__o221a_2 _4790_ (.A1(_2571_),
    ...
    .C1(_2579_),
    .X(_2580_));
 sky130_fd_sc_hd__a211oi_2 _4791_ (.A1(net737),
    .A2(_2580_),
    .B1(_1627_),
    .C1(net890),
    .Y(_2581_));
 sky130_fd_sc_hd__a211o_2 _4792_ (.A1(net779),
    .A2(\next_pc[27] ),
    .B1(_2567_),
    .C1(_2581_),
    .X(_2582_));
 ...
 sky130_fd_sc_hd__xor2_2 _4795_ (.A(_2265_),
    .B(_2575_),
    .X(_2584_));
 sky130_fd_sc_hd__a311oi_2 _4796_ (.A1(net934),
    .A2(_2569_),
    .A3(_2314_),
    .B1(_2570_),
    .C1(net692),
    .Y(_2585_));
 sky130_fd_sc_hd__a22o_2 _4797_ (.A1(net740),
    .A2(_2264_),
    .B1(_2265_),
    .B2(net685),
    .X(_2586_));
 sky130_fd_sc_hd__a211o_2 _4798_ (.A1(net686),
    .A2(_2584_),
    .B1(_2585_),
    .C1(_2586_),
    .X(net858));
 sky130_fd_sc_hd__or2_2 _4799_ (.A(net732),
    .B(net858),
    .X(_2587_));
 sky130_fd_sc_hd__a21oi_2 _4800_ (.A1(net916),
    .A2(_2510_),
    .B1(net917),
    .Y(_2588_));
 sky130_fd_sc_hd__nor2_2 _4801_ (.A(_2511_),
    .B(_2588_),
    .Y(\next_pc[26] ));
 sky130_fd_sc_hd__o21a_2 _4802_ (.A1(net916),
    .A2(net776),
    .B1(_2489_),
    .X(_2589_));
 sky130_fd_sc_hd__o211ai_2 _4803_ (.A1(net917),
    .A2(_2589_),
    .B1(net819),
    .C1(net838),
    .Y(_2590_));
 sky130_fd_sc_hd__or2_2 _4804_ (.A(_2491_),
    .B(_2590_),
    .X(_2591_));
 sky130_fd_sc_hd__a21bo_2 _4805_ (.A1(net779),
    .A2(\next_pc[26] ),
    .B1_N(_2591_),
    .X(_2592_));
 ...
 sky130_fd_sc_hd__mux2_2 _4807_ (.A0(\RF.registers[9][26] ),
    ...
    .S(net751),
    .X(_2594_));
 sky130_fd_sc_hd__xor2_2 _4809_ (.A(net916),
    .B(_2510_),
    .X(\next_pc[25] ));
 ...
 sky130_fd_sc_hd__nand2_2 _4813_ (.A(_2294_),
    .B(_2307_),
    .Y(_2598_));
 sky130_fd_sc_hd__nor2_2 _4814_ (.A(net692),
    .B(_2313_),
    .Y(_2599_));
 sky130_fd_sc_hd__o211a_2 _4815_ (.A1(_2597_),
    ...
    .C1(_2569_),
    .X(_2600_));
 sky130_fd_sc_hd__a22o_2 _4816_ (.A1(net740),
    .A2(_2451_),
    .B1(_2294_),
    .B2(net685),
    .X(_2601_));
 sky130_fd_sc_hd__a211o_2 _4817_ (.A1(_2595_),
    ...
    .C1(_2601_),
    .X(net857));
 sky130_fd_sc_hd__nand2_2 _4818_ (.A(net916),
    .B(_2489_),
    .Y(_2602_));
 sky130_fd_sc_hd__o211a_2 _4819_ (.A1(net916),
    .A2(_2489_),
    .B1(_2602_),
    .C1(net785),
    .X(_2603_));
 sky130_fd_sc_hd__nand2_2 _4820_ (.A(net821),
    .B(_1345_),
    .Y(_2604_));
 sky130_fd_sc_hd__a211o_2 _4821_ (.A1(net731),
    .A2(_1632_),
    .B1(_2603_),
    .C1(_2604_),
    .X(_2605_));
 sky130_fd_sc_hd__o22a_2 _4822_ (.A1(net820),
    .A2(\next_pc[25] ),
    .B1(net857),
    .B2(_2605_),
    .X(_2606_));
 sky130_fd_sc_hd__mux2_2 _4823_ (.A0(\RF.registers[9][25] ),
    ...
    .S(net753),
    .X(_2607_));
 sky130_fd_sc_hd__nor2_2 _4825_ (.A(net915),
    .B(_2509_),
    .Y(_2608_));
 ...
 sky130_fd_sc_hd__xor2_2 _4827_ (.A(_2309_),
    .B(_2568_),
    .X(_2609_));
 sky130_fd_sc_hd__a22o_2 _4828_ (.A1(net740),
    .A2(_2452_),
    .B1(_2309_),
    .B2(net685),
    .X(_2610_));
 ...
 sky130_fd_sc_hd__o21a_2 _4830_ (.A1(_2448_),
    ...
    .B1(_2611_),
    .X(_2612_));
 sky130_fd_sc_hd__a211o_2 _4831_ (.A1(net689),
    .A2(_2609_),
    .B1(_2610_),
    .C1(_2612_),
    .X(net856));
 sky130_fd_sc_hd__or2_2 _4832_ (.A(net731),
    .B(net856),
    .X(_2613_));
 sky130_fd_sc_hd__o21ai_2 _4833_ (.A1(net915),
    .A2(_2488_),
    .B1(net785),
    .Y(_2614_));
 ...
 sky130_fd_sc_hd__and2_2 _4852_ (.A(_1557_),
    .B(_1464_),
    .X(_2632_));
 sky130_fd_sc_hd__o22a_2 _4854_ (.A1(net742),
    .A2(_1962_),
    .B1(_1964_),
    .B2(_2632_),
    .X(_2634_));
 ...
 sky130_fd_sc_hd__or3b_4 _4857_ (.A(_2335_),
    ...
    .C_N(net931),
    .X(_2636_));
 sky130_fd_sc_hd__and2_2 _4858_ (.A(net913),
    .B(_2487_),
    .X(_2637_));
 sky130_fd_sc_hd__nor2_2 _4859_ (.A(net914),
    .B(_2637_),
    .Y(_2638_));
 sky130_fd_sc_hd__o21ai_2 _4860_ (.A1(_2488_),
    ...
    .B1(net786),
    .Y(_2639_));
 sky130_fd_sc_hd__a31o_2 _4861_ (.A1(net912),
    .A2(net913),
    .A3(_2508_),
    .B1(net914),
    .X(_2640_));
 sky130_fd_sc_hd__and2b_2 _4862_ (.A_N(_2509_),
    .B(_2640_),
    .X(_2641_));
 sky130_fd_sc_hd__a32o_2 _4864_ (.A1(net739),
    .A2(_2636_),
    .A3(_2639_),
    .B1(_2641_),
    .B2(net779),
 ...
 sky130_fd_sc_hd__mux2_2 _4865_ (.A0(\RF.registers[9][23] ),
    ...
    .S(net752),
    .X(_2643_));
 sky130_fd_sc_hd__nand2_2 _4867_ (.A(net912),
    .B(_2508_),
    .Y(_2644_));
 sky130_fd_sc_hd__xnor2_2 _4868_ (.A(net913),
    .B(_2644_),
    .Y(\next_pc[22] ));
 sky130_fd_sc_hd__o21ai_2 _4869_ (.A1(net913),
    .A2(_2487_),
    .B1(net786),
    .Y(_2645_));
 ...
 sky130_fd_sc_hd__and2_2 _4872_ (.A(_2625_),
    .B(_2628_),
    .X(_2648_));
 sky130_fd_sc_hd__o22a_2 _4873_ (.A1(net742),
    .A2(_1978_),
    .B1(_1979_),
    .B2(_2632_),
    .X(_2649_));
 sky130_fd_sc_hd__o31a_2 _4874_ (.A1(net692),
    .A2(_2629_),
    .A3(_2648_),
    .B1(_2649_),
    .X(_2650_));
 sky130_fd_sc_hd__a21bo_2 _4875_ (.A1(_2622_),
    ...
    .B1_N(_2650_),
    .X(net854));
 sky130_fd_sc_hd__o211a_2 _4877_ (.A1(net731),
    .A2(net854),
    .B1(_1675_),
    .C1(_1293_),
    .X(_2652_));
 sky130_fd_sc_hd__a211o_2 _4878_ (.A1(net779),
    .A2(\next_pc[22] ),
    .B1(_2646_),
    .C1(_2652_),
    .X(_2653_));
 sky130_fd_sc_hd__mux2_2 _4879_ (.A0(\RF.registers[9][22] ),
    ...
    .S(net753),
    .X(_2654_));
 sky130_fd_sc_hd__or2_2 _4881_ (.A(net912),
    .B(_2508_),
    .X(_2655_));
 ...
 sky130_fd_sc_hd__nor2_2 _4890_ (.A(_2632_),
    .B(_1994_),
    .Y(_2663_));
 sky130_fd_sc_hd__a221o_2 _4891_ (.A1(net740),
    .A2(_1992_),
    .B1(_2662_),
    .B2(net686),
    .C1(_2663_),
 ...
 sky130_fd_sc_hd__and2_2 _4894_ (.A(_2468_),
    .B(_2665_),
    .X(_2666_));
 sky130_fd_sc_hd__a21o_2 _4895_ (.A1(net911),
    .A2(net776),
    .B1(_2666_),
    .X(_2667_));
 ...
 sky130_fd_sc_hd__o211a_2 _4897_ (.A1(_2469_),
    ...
    .C1(net785),
    .X(_2669_));
 sky130_fd_sc_hd__a211o_2 _4898_ (.A1(net731),
    .A2(_1677_),
    .B1(_2669_),
    .C1(_2604_),
    .X(_2670_));
 sky130_fd_sc_hd__o22a_2 _4899_ (.A1(net820),
    .A2(_2656_),
    .B1(net853),
    .B2(_2670_),
    .X(_2671_));
 ...
 sky130_fd_sc_hd__and2b_2 _4904_ (.A_N(_2076_),
    .B(_2627_),
    .X(_2675_));
 sky130_fd_sc_hd__o2bb2a_2 _4905_ (.A1_N(net740),
    .A2_N(_2444_),
    .B1(_2076_),
    .B2(_2632_),
    .X(_2676_));
 sky130_fd_sc_hd__o31a_2 _4906_ (.A1(net692),
    .A2(_2658_),
    .A3(_2675_),
    .B1(_2676_),
    .X(_2677_));
 sky130_fd_sc_hd__o31ai_4 _4907_ (.A1(net691),
    .A2(_2620_),
    .A3(_2674_),
    .B1(_2677_),
    .Y(net1));
 ...
 sky130_fd_sc_hd__or3_2 _4909_ (.A(_1264_),
    ...
    .C(_2678_),
    .X(_2679_));
 sky130_fd_sc_hd__nand2_2 _4910_ (.A(net739),
    .B(_2679_),
    .Y(_2680_));
 sky130_fd_sc_hd__nor2_2 _4911_ (.A(net911),
    .B(_2507_),
    .Y(_2681_));
 ...
 sky130_fd_sc_hd__a21o_2 _4924_ (.A1(_2026_),
    ...
    .B1(_2691_),
    .X(_2692_));
 sky130_fd_sc_hd__o221a_2 _4925_ (.A1(net742),
    .A2(_2024_),
    .B1(_2026_),
    .B2(_2632_),
    .C1(_2692_),
    .X(_2693_));
 sky130_fd_sc_hd__o21ai_2 _4926_ (.A1(_1486_),
    .A2(_2688_),
    .B1(_2693_),
    .Y(net75));
 sky130_fd_sc_hd__or3_2 _4927_ (.A(_2335_),
    ...
    .C(net75),
    .X(_2694_));
 sky130_fd_sc_hd__nor3_2 _4928_ (.A(net909),
    .B(_2471_),
    .C(_2484_),
    .Y(_2695_));
 sky130_fd_sc_hd__o21ai_2 _4929_ (.A1(_2665_),
    ...
    .B1(net786),
    .Y(_2696_));
 sky130_fd_sc_hd__a21oi_2 _4930_ (.A1(net908),
    .A2(_2506_),
    .B1(net909),
    .Y(_2697_));
 sky130_fd_sc_hd__nor2_2 _4931_ (.A(_2507_),
    .B(_2697_),
    .Y(\next_pc[19] ));
 sky130_fd_sc_hd__a32o_2 _4932_ (.A1(net739),
    .A2(_2694_),
    .A3(_2696_),
    .B1(\next_pc[19] ),
    .B2(net779),
 ...
 sky130_fd_sc_hd__mux2_2 _4933_ (.A0(\RF.registers[9][19] ),
    ...
    .S(net754),
    .X(_2699_));
 sky130_fd_sc_hd__xor2_2 _4935_ (.A(net908),
    .B(_2506_),
    .X(\next_pc[18] ));
 ...
 sky130_fd_sc_hd__nor2_2 _4938_ (.A(_1455_),
    .B(_2038_),
    .Y(_2702_));
 sky130_fd_sc_hd__o32a_2 _4939_ (.A1(net742),
    .A2(_2039_),
    .A3(_2702_),
    .B1(_2247_),
    .B2(_1557_),
    .X(_2703_));
 sky130_fd_sc_hd__o21ai_2 _4940_ (.A1(net692),
    .A2(_2701_),
    .B1(_2703_),
    .Y(_2704_));
 sky130_fd_sc_hd__a21o_2 _4941_ (.A1(net686),
    .A2(_2700_),
    .B1(_2704_),
    .X(net849));
 sky130_fd_sc_hd__o211ai_2 _4942_ (.A1(net908),
    .A2(_2483_),
    .B1(net819),
    .C1(net838),
    .Y(_2705_));
 ...
 sky130_fd_sc_hd__or3_2 _4944_ (.A(_2604_),
    ...
    .C(_2706_),
    .X(_2707_));
 sky130_fd_sc_hd__o22a_2 _4945_ (.A1(net820),
    .A2(\next_pc[18] ),
    .B1(net849),
    .B2(_2707_),
    .X(_2708_));
 ...
 sky130_fd_sc_hd__nand2_2 _4949_ (.A(_2684_),
    .B(_2249_),
    .Y(_2711_));
 sky130_fd_sc_hd__nor2_2 _4950_ (.A(net683),
    .B(_2439_),
    .Y(_2712_));
 ...
 sky130_fd_sc_hd__or2b_2 _4952_ (.A(_2249_),
    .B_N(_2246_),
    .X(_2714_));
 sky130_fd_sc_hd__a31oi_2 _4953_ (.A1(net683),
    .A2(_2067_),
    .A3(_2714_),
    .B1(net692),
    .Y(_2715_));
 sky130_fd_sc_hd__o211a_2 _4954_ (.A1(net683),
    .A2(_2714_),
    .B1(_2715_),
    .C1(_2068_),
    .X(_2716_));
 sky130_fd_sc_hd__a22o_2 _4955_ (.A1(net740),
    .A2(_2438_),
    .B1(net683),
    .B2(net685),
    .X(_2717_));
 ...
 sky130_fd_sc_hd__inv_2 _4958_ (.A(_2718_),
    .Y(_2719_));
 sky130_fd_sc_hd__a21oi_2 _4959_ (.A1(net906),
    .A2(_2719_),
    .B1(net907),
    .Y(_2720_));
 sky130_fd_sc_hd__nor3_2 _4960_ (.A(net822),
    .B(_2483_),
    .C(_2720_),
    .Y(_2721_));
 sky130_fd_sc_hd__or3_4 _4961_ (.A(_1708_),
    ...
    .C(_2721_),
    .X(_2722_));
 sky130_fd_sc_hd__nor2_2 _4962_ (.A(net907),
    .B(_2505_),
    .Y(_2723_));
 sky130_fd_sc_hd__nor2_2 _4963_ (.A(_2506_),
    .B(_2723_),
    .Y(\next_pc[17] ));
 sky130_fd_sc_hd__a22o_2 _4964_ (.A1(net739),
    .A2(_2722_),
    .B1(\next_pc[17] ),
    .B2(net779),
    .X(_2724_));
 ...
 sky130_fd_sc_hd__and3b_2 _4969_ (.A_N(_2727_),
    ...
    .C(_2714_),
    .X(_2728_));
 sky130_fd_sc_hd__a22o_2 _4970_ (.A1(net740),
    .A2(_2439_),
    .B1(_2249_),
    .B2(net685),
    .X(_2729_));
 sky130_fd_sc_hd__a311oi_2 _4971_ (.A1(net686),
    .A2(_2711_),
    .A3(_2726_),
    .B1(_2728_),
    .C1(_2729_),
 ...
 sky130_fd_sc_hd__or3b_2 _4973_ (.A(_2335_),
    ...
    .C_N(_1729_),
    .X(_2731_));
 sky130_fd_sc_hd__xor2_2 _4974_ (.A(net906),
    .B(_2718_),
    .X(_2732_));
 sky130_fd_sc_hd__nand2_2 _4975_ (.A(net786),
    .B(_2732_),
    .Y(_2733_));
 sky130_fd_sc_hd__a21oi_2 _4976_ (.A1(net905),
    .A2(_2504_),
    .B1(net906),
    .Y(_2734_));
 sky130_fd_sc_hd__nor2_2 _4977_ (.A(_2505_),
    .B(_2734_),
    .Y(\next_pc[16] ));
 sky130_fd_sc_hd__a32o_2 _4978_ (.A1(net739),
    .A2(_2731_),
    .A3(_2733_),
    .B1(\next_pc[16] ),
    .B2(net779),
 ...
 sky130_fd_sc_hd__mux2_2 _4979_ (.A0(\RF.registers[9][16] ),
    ...
    .S(net754),
    .X(_2736_));
 sky130_fd_sc_hd__xor2_2 _4981_ (.A(net905),
    .B(_2504_),
    .X(\next_pc[15] ));
 sky130_fd_sc_hd__or3_2 _4982_ (.A(net905),
    .B(_2473_),
    .C(_2482_),
    .X(_2737_));
 ...
 sky130_fd_sc_hd__a21oi_2 _4986_ (.A1(_2126_),
    ...
    .B1(_2428_),
    .Y(_2741_));
 sky130_fd_sc_hd__xnor2_2 _4987_ (.A(net938),
    .B(_2741_),
    .Y(_2742_));
 ...
 sky130_fd_sc_hd__a21oi_2 _4991_ (.A1(_2743_),
    ...
    .B1(_2124_),
    .Y(_2746_));
 sky130_fd_sc_hd__a21oi_2 _4992_ (.A1(net938),
    .A2(_2746_),
    .B1(net692),
    .Y(_2747_));
 sky130_fd_sc_hd__o21a_2 _4993_ (.A1(net938),
    .A2(_2746_),
    .B1(_2747_),
    .X(_2748_));
 sky130_fd_sc_hd__a22o_2 _4994_ (.A1(net740),
    .A2(net940),
    .B1(net938),
    .B2(net685),
    .X(_2749_));
 sky130_fd_sc_hd__a211o_2 _4995_ (.A1(net686),
    .A2(_2742_),
    .B1(_2748_),
    .C1(_2749_),
    .X(net846));
 sky130_fd_sc_hd__o211a_2 _4996_ (.A1(net733),
    .A2(net846),
    .B1(_1732_),
    .C1(_1293_),
    .X(_2750_));
 sky130_fd_sc_hd__a211o_2 _4997_ (.A1(net779),
    .A2(\next_pc[15] ),
    .B1(_2738_),
    .C1(_2750_),
    .X(_2751_));
 sky130_fd_sc_hd__mux2_2 _4998_ (.A0(\RF.registers[9][15] ),
    ...
    .S(net754),
    .X(_2752_));
 sky130_fd_sc_hd__nor2_2 _5000_ (.A(net904),
    .B(_2503_),
    .Y(_2753_));
 ...
 sky130_fd_sc_hd__a21oi_2 _5005_ (.A1(_2743_),
    ...
    .B1(net692),
    .Y(_2757_));
 sky130_fd_sc_hd__a22o_2 _5006_ (.A1(net740),
    .A2(_2428_),
    .B1(_2126_),
    .B2(net685),
    .X(_2758_));
 ...
 sky130_fd_sc_hd__or4_2 _5010_ (.A(_2604_),
    ...
    .D(_2760_),
    .X(_2761_));
 sky130_fd_sc_hd__o21a_2 _5011_ (.A1(net820),
    .A2(\next_pc[14] ),
    .B1(_2761_),
    .X(_2762_));
 sky130_fd_sc_hd__mux2_2 _5012_ (.A0(\RF.registers[9][14] ),
    ...
    .S(net754),
    .X(_2763_));
 sky130_fd_sc_hd__or2_2 _5014_ (.A(net903),
    .B(_2480_),
    .X(_2764_));
 ...
 sky130_fd_sc_hd__or3b_2 _5020_ (.A(_1460_),
    ...
    .C_N(_2241_),
    .X(_2770_));
 sky130_fd_sc_hd__o2bb2a_2 _5021_ (.A1_N(net741),
    .A2_N(_2092_),
    .B1(_2240_),
    .B2(_2632_),
    .X(_2771_));
 ...
 sky130_fd_sc_hd__inv_2 _5023_ (.A(_2772_),
    .Y(net844));
 sky130_fd_sc_hd__a211o_2 _5024_ (.A1(net733),
    .A2(_1745_),
    .B1(_2765_),
    .C1(net844),
    .X(_2773_));
 sky130_fd_sc_hd__a21oi_2 _5025_ (.A1(net902),
    .A2(_2502_),
    .B1(net903),
    .Y(_2774_));
 ...
 sky130_fd_sc_hd__mux2_2 _5028_ (.A0(\RF.registers[9][13] ),
    ...
    .S(net749),
    .X(_2776_));
 sky130_fd_sc_hd__xor2_2 _5030_ (.A(net902),
    .B(_2502_),
    .X(\next_pc[12] ));
 ...
 sky130_fd_sc_hd__xnor2_2 _5032_ (.A(_2109_),
    .B(_2238_),
    .Y(_2778_));
 sky130_fd_sc_hd__a22o_2 _5033_ (.A1(net741),
    .A2(_2431_),
    .B1(_2109_),
    .B2(net685),
    .X(_2779_));
 sky130_fd_sc_hd__a221o_2 _5034_ (.A1(net686),
    .A2(_2777_),
    .B1(_2778_),
    .B2(net689),
    .C1(_2779_),
 ...
 sky130_fd_sc_hd__or2b_2 _5036_ (.A(_2479_),
    .B_N(_2476_),
    .X(_2781_));
 sky130_fd_sc_hd__nand2_2 _5037_ (.A(net901),
    .B(_2478_),
    .Y(_2782_));
 sky130_fd_sc_hd__xor2_2 _5038_ (.A(_2781_),
    .B(_2782_),
    .X(_2783_));
 sky130_fd_sc_hd__o32a_2 _5039_ (.A1(net819),
    .A2(_1768_),
    .A3(net843),
    .B1(_2783_),
    .B2(net823),
 ...
 sky130_fd_sc_hd__mux2_2 _5041_ (.A0(\RF.registers[9][12] ),
    ...
    .S(net750),
    .X(_2786_));
 sky130_fd_sc_hd__nor2_2 _5043_ (.A(net901),
    .B(_2501_),
    .Y(_2787_));
 sky130_fd_sc_hd__nor2_2 _5044_ (.A(_2502_),
    .B(_2787_),
    .Y(\next_pc[11] ));
 sky130_fd_sc_hd__or2_2 _5045_ (.A(net901),
    .B(_2478_),
    .X(_2788_));
 ...
 sky130_fd_sc_hd__o31ai_1 _5047_ (.A1(_2414_),
    ...
    .B1(_2789_),
    .Y(_2790_));
 sky130_fd_sc_hd__o21bai_2 _5048_ (.A1(net684),
    .A2(net932),
    .B1_N(_2423_),
    .Y(_2791_));
 ...
 sky130_fd_sc_hd__inv_2 _5054_ (.A(_2235_),
    .Y(_2797_));
 sky130_fd_sc_hd__a221o_2 _5055_ (.A1(net686),
    .A2(_2792_),
    .B1(_2796_),
    .B2(_2797_),
    .C1(_2231_),
 ...
 sky130_fd_sc_hd__nor2_2 _5057_ (.A(_1464_),
    .B(_2196_),
    .Y(_2800_));
 sky130_fd_sc_hd__a211o_2 _5058_ (.A1(net741),
    .A2(_2197_),
    .B1(_2799_),
    .C1(_2800_),
    .X(net842));
 sky130_fd_sc_hd__a21o_2 _5059_ (.A1(net730),
    .A2(_1770_),
    .B1(net842),
    .X(_2801_));
 sky130_fd_sc_hd__a22o_2 _5060_ (.A1(net784),
    .A2(_2788_),
    .B1(_2801_),
    .B2(_1263_),
    .X(_2802_));
 ...
 sky130_fd_sc_hd__mux2_2 _5063_ (.A0(\RF.registers[9][11] ),
    ...
    .S(net749),
    .X(_2805_));
 sky130_fd_sc_hd__a21oi_2 _5065_ (.A1(net930),
    .A2(_2500_),
    .B1(net900),
    .Y(_2806_));
 sky130_fd_sc_hd__nor2_2 _5066_ (.A(_2501_),
    .B(_2806_),
    .Y(\next_pc[10] ));
 sky130_fd_sc_hd__or2_2 _5067_ (.A(net888),
    .B(_2477_),
    .X(_2807_));
 sky130_fd_sc_hd__and3_2 _5068_ (.A(net929),
    .B(net930),
    .C(_2807_),
    .X(_2808_));
 sky130_fd_sc_hd__or2_2 _5069_ (.A(net900),
    .B(_2808_),
    .X(_2809_));
 sky130_fd_sc_hd__o21a_2 _5070_ (.A1(_2228_),
    ...
    .B1(_2796_),
    .X(_2810_));
 sky130_fd_sc_hd__nand2_2 _5071_ (.A(net697),
    .B(_2227_),
    .Y(_2811_));
 sky130_fd_sc_hd__and3_2 _5072_ (.A(net741),
    .B(_2226_),
    .C(_2811_),
    .X(_2812_));
 ...
 sky130_fd_sc_hd__or3_2 _5075_ (.A(_2810_),
    ...
    .C(_2814_),
    .X(net841));
 sky130_fd_sc_hd__a21o_2 _5077_ (.A1(net730),
    .A2(_1773_),
    .B1(net841),
    .X(_2816_));
 sky130_fd_sc_hd__a221o_2 _5078_ (.A1(net784),
    .A2(_2809_),
    .B1(_2816_),
    .B2(_1263_),
    .C1(net781),
    .X(_2817_));
 sky130_fd_sc_hd__o21a_2 _5079_ (.A1(net821),
    .A2(\next_pc[10] ),
    .B1(_2817_),
    .X(_2818_));
 sky130_fd_sc_hd__mux2_2 _5080_ (.A0(\RF.registers[9][10] ),
    ...
    .S(net749),
    .X(_2819_));
 sky130_fd_sc_hd__xor2_2 _5082_ (.A(net930),
    .B(_2500_),
    .X(\next_pc[9] ));
 sky130_fd_sc_hd__or2b_2 _5083_ (.A(net684),
    .B_N(_2211_),
    .X(_2820_));
 sky130_fd_sc_hd__and3b_2 _5084_ (.A_N(_2211_),
    ...
    .C(net684),
    .X(_2821_));
 sky130_fd_sc_hd__o21ba_2 _5085_ (.A1(net684),
    .A2(net933),
    .B1_N(_2821_),
    .X(_2822_));
 sky130_fd_sc_hd__and3_2 _5086_ (.A(net684),
    .B(_2213_),
    .C(_2167_),
    .X(_2823_));
 sky130_fd_sc_hd__a211oi_2 _5087_ (.A1(_2213_),
    ...
    .C1(_2233_),
    .Y(_2824_));
 sky130_fd_sc_hd__a2111o_2 _5088_ (.A1(net684),
    .A2(_2233_),
    .B1(_2823_),
    .C1(_2824_),
    .D1(_1460_),
    .X(_2825_));
 sky130_fd_sc_hd__o221ai_2 _5089_ (.A1(net742),
    .A2(_2181_),
    .B1(net684),
    .B2(_2632_),
    .C1(_2825_),
    .Y(_2826_));
 sky130_fd_sc_hd__a31o_2 _5090_ (.A1(net687),
    .A2(_2820_),
    .A3(_2822_),
    .B1(_2826_),
    .X(net871));
 sky130_fd_sc_hd__a21o_2 _5091_ (.A1(net929),
    .A2(_2807_),
    .B1(net930),
    .X(_2827_));
 sky130_fd_sc_hd__and3b_2 _5092_ (.A_N(_2808_),
    ...
    .C(_2408_),
    .X(_2828_));
 sky130_fd_sc_hd__o32a_2 _5093_ (.A1(net784),
    .A2(_1776_),
    .A3(net871),
    .B1(_2828_),
    .B2(_1293_),
    .X(_2829_));
 sky130_fd_sc_hd__a21o_2 _5094_ (.A1(net781),
    .A2(\next_pc[9] ),
    .B1(_2829_),
    .X(_2830_));
 sky130_fd_sc_hd__mux2_2 _5095_ (.A0(\RF.registers[9][9] ),
    ...
    .S(net750),
    .X(_2831_));
 sky130_fd_sc_hd__nor2_2 _5097_ (.A(net929),
    .B(_2499_),
    .Y(_2832_));
 ...
 sky130_fd_sc_hd__nor2_2 _5101_ (.A(_2632_),
    .B(_2213_),
    .Y(_2835_));
 sky130_fd_sc_hd__a221o_2 _5102_ (.A1(net741),
    .A2(_2211_),
    .B1(_2834_),
    .B2(_1554_),
    .C1(_2835_),
    .X(_2836_));
 sky130_fd_sc_hd__a31oi_2 _5103_ (.A1(net687),
    .A2(_2790_),
    .A3(_2833_),
    .B1(_2836_),
    .Y(_2837_));
 sky130_fd_sc_hd__nand2_2 _5104_ (.A(net738),
    .B(_2837_),
    .Y(_2838_));
 sky130_fd_sc_hd__a31o_2 _5105_ (.A1(_1263_),
    ...
    .B1(net781),
    .X(_2839_));
 sky130_fd_sc_hd__o21a_2 _5106_ (.A1(net929),
    .A2(_2807_),
    .B1(net784),
    .X(_2840_));
 sky130_fd_sc_hd__o22a_2 _5107_ (.A1(net821),
    .A2(\next_pc[8] ),
    .B1(_2839_),
    .B2(_2840_),
    .X(_2841_));
 ...
 sky130_fd_sc_hd__xnor2_2 _5113_ (.A(_2162_),
    .B(_2845_),
    .Y(_2846_));
 sky130_fd_sc_hd__nand2_2 _5114_ (.A(net741),
    .B(_2414_),
    .Y(_2847_));
 ...
 sky130_fd_sc_hd__o21ai_2 _5116_ (.A1(_2843_),
    ...
    .B1(_2848_),
    .Y(net77));
 sky130_fd_sc_hd__or3b_2 _5117_ (.A(net783),
    .B(net77),
    .C_N(_1803_),
    .X(_2849_));
 sky130_fd_sc_hd__or4_2 _5118_ (.A(_1311_),
    ...
    .D(_1290_),
    .X(_2850_));
 sky130_fd_sc_hd__a21oi_2 _5119_ (.A1(net830),
    .A2(_2498_),
    .B1(net928),
    .Y(_2851_));
 ...
 sky130_fd_sc_hd__a21o_2 _5124_ (.A1(_1550_),
    ...
    .B1(net819),
    .X(_2854_));
 sky130_fd_sc_hd__nand2_2 _5125_ (.A(net821),
    .B(_2854_),
    .Y(_2855_));
 ...
 sky130_fd_sc_hd__a21oi_2 _5128_ (.A1(_1562_),
    ...
    .B1(net819),
    .Y(_2857_));
 sky130_fd_sc_hd__nor2_2 _5129_ (.A(net832),
    .B(net839),
    .Y(_2858_));
 ...
 sky130_fd_sc_hd__mux2_2 _5132_ (.A0(\RF.registers[9][5] ),
    ...
    .S(_1355_),
    .X(_2860_));
 sky130_fd_sc_hd__o21a_2 _5134_ (.A1(net866),
    .A2(_1812_),
    .B1(_1293_),
    .X(_2861_));
 sky130_fd_sc_hd__a211o_2 _5135_ (.A1(net834),
    .A2(net781),
    .B1(net783),
    .C1(_2861_),
    .X(_2862_));
 sky130_fd_sc_hd__mux2_2 _5136_ (.A0(\RF.registers[9][4] ),
    ...
    .S(net756),
    .X(_2863_));
 sky130_fd_sc_hd__mux2_2 _5138_ (.A0(net681),
    .A1(_1817_),
    .S(net735),
    .X(_2864_));
 sky130_fd_sc_hd__o21a_2 _5139_ (.A1(net819),
    .A2(_2864_),
    .B1(_2408_),
    .X(_2865_));
 ...
 sky130_fd_sc_hd__a31o_2 _5150_ (.A1(_1441_),
    ...
    .B1(_2873_),
    .X(net851));
 sky130_fd_sc_hd__or2_2 _5151_ (.A(net733),
    .B(net851),
    .X(_2874_));
 sky130_fd_sc_hd__nand2_2 _5152_ (.A(net899),
    .B(_1438_),
    .Y(_2875_));
 sky130_fd_sc_hd__xor2_2 _5153_ (.A(net828),
    .B(_1423_),
    .X(_2876_));
 ...
 sky130_fd_sc_hd__a31o_2 _5155_ (.A1(_1263_),
    ...
    .B1(_2877_),
    .X(_2878_));
 sky130_fd_sc_hd__mux2_2 _5156_ (.A0(net828),
    .A1(_2878_),
    .S(net821),
    .X(_2879_));
 ...
 sky130_fd_sc_hd__mux2_2 _5159_ (.A0(\RF.registers[9][0] ),
    ...
    .S(_1355_),
    .X(_2881_));
 sky130_fd_sc_hd__or2_2 _5161_ (.A(net576),
    .B(_1319_),
    .X(_2882_));
 ...
 sky130_fd_sc_hd__inv_2 _5228_ (.A(_1275_),
    .Y(net896));
 sky130_fd_sc_hd__and3b_2 _5229_ (.A_N(net897),
    .B(net896),
    .C(net945),
    .X(_2917_));
 ...
 sky130_fd_sc_hd__mux2_2 _5236_ (.A0(\RF.registers[5][29] ),
    ...
    .S(net709),
    .X(_2922_));
 sky130_fd_sc_hd__or3b_2 _5238_ (.A(net897),
    .B(_1275_),
    .C_N(_1321_),
    .X(_2923_));
 ...
 sky130_fd_sc_hd__a21o_2 _5282_ (.A1(\RF.registers[5][6] ),
    ...
    .B1(_1546_),
    .X(_0900_));
 sky130_fd_sc_hd__a22o_2 _5283_ (.A1(net690),
    .A2(_2557_),
    .B1(_2923_),
    .B2(\RF.registers[5][5] ),
    .X(_0899_));
 ...
 sky130_fd_sc_hd__mux2_2 _5360_ (.A0(\RF.registers[4][0] ),
    ...
    .S(net775),
    .X(_2984_));
 sky130_fd_sc_hd__and3b_2 _5362_ (.A_N(net872),
    .B(_1262_),
    .C(net897),
    .X(_2985_));
 ...
 sky130_fd_sc_hd__and2_2 _5634_ (.A(\RF.registers[15][3] ),
    .B(_1345_),
    .X(_3117_));
 sky130_fd_sc_hd__nor2_2 _5640_ (.A(net780),
    .B(_1288_),
    .Y(net893));
 sky130_fd_sc_hd__inv_2 _5641_ (.A(_1319_),
    .Y(net879));
 sky130_fd_sc_hd__or2_2 _5642_ (.A(net780),
    .B(_1298_),
    .X(_3120_));
 sky130_fd_sc_hd__buf_1 _5643_ (.A(_3120_),
    .X(net894));
 sky130_fd_sc_hd__o211a_2 _5644_ (.A1(net833),
    .A2(_2858_),
    .B1(_1256_),
    .C1(net837),
    .X(_3121_));
 sky130_fd_sc_hd__o31a_2 _5645_ (.A1(net832),
    .A2(net839),
    .A3(_1253_),
    .B1(_3121_),
    .X(net874));
 ...
 sky130_fd_sc_hd__nand2_2 _5647_ (.A(_1264_),
    .B(_1268_),
    .Y(net873));
 sky130_fd_sc_hd__or2_2 _5648_ (.A(net888),
    .B(_1501_),
    .X(_3122_));
 ...
 sky130_fd_sc_hd__inv_2 _5654_ (.A(_2465_),
    .Y(net864));
 sky130_fd_sc_hd__nor4_2 _5655_ (.A(net863),
    .B(_2327_),
    .C(_2332_),
    .D(net855),
    .Y(_3123_));
 sky130_fd_sc_hd__nor3_2 _5656_ (.A(net858),
    .B(net853),
    .C(net646),
    .Y(_3124_));
 sky130_fd_sc_hd__nor4_2 _5657_ (.A(net856),
    .B(net647),
    .C(net849),
    .D(net846),
    .Y(_3125_));
 sky130_fd_sc_hd__nor4_2 _5658_ (.A(net841),
    .B(net843),
    .C(net871),
    .D(net648),
    .Y(_3126_));
 ...
 sky130_fd_sc_hd__and4_2 _5661_ (.A(_2772_),
    ...
    .D(_3128_),
    .X(_3129_));
 sky130_fd_sc_hd__or4b_4 _5662_ (.A(net845),
    .B(net842),
    .C(net848),
    .D_N(_3129_),
    .X(_3130_));
 sky130_fd_sc_hd__nor4_2 _5663_ (.A(net860),
    .B(net857),
    .C(net854),
    .D(_3130_),
    .Y(_3131_));
 ...
 sky130_fd_sc_hd__and4_2 _5665_ (.A(_2465_),
    ...
    .D(_3132_),
    .X(_3133_));
 sky130_fd_sc_hd__or2_2 _5666_ (.A(net781),
    .B(_3133_),
    .X(_3134_));
 sky130_fd_sc_hd__nor2_2 _5667_ (.A(net838),
    .B(_3134_),
    .Y(\next_pc[2] ));
 sky130_fd_sc_hd__or2_2 _5668_ (.A(_1300_),
    .B(_3134_),
    .X(_3135_));
 sky130_fd_sc_hd__nand2_2 _5670_ (.A(net830),
    .B(_2498_),
    .Y(_3136_));
 ...
 sky130_fd_sc_hd__inv_2 _6270_ (.A(net51),
    .Y(_0011_));
 sky130_fd_sc_hd__inv_2 _6271_ (.A(net949),
    .Y(_0012_));
 sky130_fd_sc_hd__inv_2 _6272_ (.A(net66),
    .Y(_0013_));
 sky130_fd_sc_hd__inv_2 _6273_ (.A(net66),
    .Y(_0014_));
 sky130_fd_sc_hd__inv_2 _6274_ (.A(net949),
    .Y(_0015_));
 sky130_fd_sc_hd__inv_2 _6275_ (.A(net949),
    .Y(_0016_));
 sky130_fd_sc_hd__inv_2 _6276_ (.A(net69),
    .Y(_0017_));
 sky130_fd_sc_hd__inv_2 _6277_ (.A(net69),
    .Y(_0018_));
 sky130_fd_sc_hd__inv_2 _6278_ (.A(net949),
    .Y(_0019_));
 ...
 sky130_fd_sc_hd__inv_2 _6293_ (.A(net39),
    .Y(_0034_));
 sky130_fd_sc_hd__inv_2 _6294_ (.A(net953),
    .Y(_0035_));
 ...
 sky130_fd_sc_hd__inv_2 _6349_ (.A(net19),
    .Y(_0090_));
 sky130_fd_sc_hd__inv_2 _6350_ (.A(net957),
    .Y(_0091_));
 ...
 sky130_fd_sc_hd__inv_2 _6367_ (.A(net24),
    .Y(_0108_));
 sky130_fd_sc_hd__inv_2 _6368_ (.A(net955),
    .Y(_0109_));
 sky130_fd_sc_hd__inv_2 _6369_ (.A(net31),
    .Y(_0110_));
 sky130_fd_sc_hd__inv_2 _6370_ (.A(net31),
    .Y(_0111_));
 sky130_fd_sc_hd__inv_2 _6371_ (.A(net955),
    .Y(_0112_));
 ...
 sky130_fd_sc_hd__inv_2 _6375_ (.A(net31),
    .Y(_0116_));
 sky130_fd_sc_hd__inv_2 _6376_ (.A(net956),
    .Y(_0117_));
 sky130_fd_sc_hd__inv_2 _6377_ (.A(net44),
    .Y(_0118_));
 sky130_fd_sc_hd__inv_2 _6378_ (.A(net953),
    .Y(_0119_));
 sky130_fd_sc_hd__inv_2 _6379_ (.A(net956),
    .Y(_0120_));
 ...
 sky130_fd_sc_hd__inv_2 _6395_ (.A(net71),
    .Y(_0136_));
 sky130_fd_sc_hd__inv_2 _6396_ (.A(net946),
    .Y(_0137_));
 ...
 sky130_fd_sc_hd__inv_2 _6417_ (.A(net54),
    .Y(_0158_));
 sky130_fd_sc_hd__inv_2 _6418_ (.A(net951),
    .Y(_0159_));
 sky130_fd_sc_hd__inv_2 _6419_ (.A(net58),
    .Y(_0160_));
 sky130_fd_sc_hd__inv_2 _6420_ (.A(net951),
    .Y(_0161_));
 ...
 sky130_fd_sc_hd__inv_2 _6427_ (.A(net67),
    .Y(_0168_));
 sky130_fd_sc_hd__inv_2 _6428_ (.A(net71),
    .Y(_0169_));
 sky130_fd_sc_hd__inv_2 _6429_ (.A(net70),
    .Y(_0170_));
 sky130_fd_sc_hd__inv_2 _6430_ (.A(net946),
    .Y(_0171_));
 ...
 sky130_fd_sc_hd__inv_2 _6445_ (.A(net42),
    .Y(_0186_));
 sky130_fd_sc_hd__inv_2 _6446_ (.A(net954),
    .Y(_0187_));
 sky130_fd_sc_hd__inv_2 _6447_ (.A(net54),
    .Y(_0188_));
 sky130_fd_sc_hd__inv_2 _6448_ (.A(net954),
    .Y(_0189_));
 ...
 sky130_fd_sc_hd__inv_2 _6451_ (.A(net56),
    .Y(_0192_));
 sky130_fd_sc_hd__inv_2 _6452_ (.A(net951),
    .Y(_0193_));
 ...
 sky130_fd_sc_hd__inv_2 _6458_ (.A(net65),
    .Y(_0199_));
 sky130_fd_sc_hd__inv_2 _6459_ (.A(net71),
    .Y(_0200_));
 ...
 sky130_fd_sc_hd__inv_2 _6476_ (.A(net36),
    .Y(_0217_));
 sky130_fd_sc_hd__inv_2 _6477_ (.A(net954),
    .Y(_0218_));
 ...
 sky130_fd_sc_hd__inv_2 _6493_ (.A(net70),
    .Y(_0234_));
 sky130_fd_sc_hd__inv_2 _6494_ (.A(net946),
    .Y(_0235_));
 ...
 sky130_fd_sc_hd__inv_2 _6498_ (.A(net29),
    .Y(_0239_));
 sky130_fd_sc_hd__inv_2 _6499_ (.A(net955),
    .Y(_0240_));
 sky130_fd_sc_hd__inv_2 _6500_ (.A(net24),
    .Y(_0241_));
 sky130_fd_sc_hd__inv_2 _6501_ (.A(net24),
    .Y(_0242_));
 sky130_fd_sc_hd__inv_2 _6502_ (.A(net955),
    .Y(_0243_));
 ...
 sky130_fd_sc_hd__inv_2 _6505_ (.A(net40),
    .Y(_0246_));
 sky130_fd_sc_hd__inv_2 _6506_ (.A(net953),
    .Y(_0247_));
 sky130_fd_sc_hd__inv_2 _6507_ (.A(net956),
    .Y(_0248_));
 ...
 sky130_fd_sc_hd__inv_2 _6513_ (.A(net58),
    .Y(_0254_));
 sky130_fd_sc_hd__inv_2 _6514_ (.A(net951),
    .Y(_0255_));
 ...
 sky130_fd_sc_hd__inv_2 _6525_ (.A(net70),
    .Y(_0266_));
 sky130_fd_sc_hd__inv_2 _6526_ (.A(net946),
    .Y(_0267_));
 ...
 sky130_fd_sc_hd__inv_2 _6541_ (.A(net37),
    .Y(_0282_));
 sky130_fd_sc_hd__inv_2 _6542_ (.A(net954),
    .Y(_0283_));
 ...
 sky130_fd_sc_hd__inv_2 _6557_ (.A(net68),
    .Y(_0298_));
 sky130_fd_sc_hd__inv_2 _6558_ (.A(net946),
    .Y(_0299_));
 ...
 sky130_fd_sc_hd__inv_2 _6561_ (.A(net29),
    .Y(_0302_));
 sky130_fd_sc_hd__inv_2 _6562_ (.A(net953),
    .Y(_0303_));
 ...
 sky130_fd_sc_hd__inv_2 _6565_ (.A(net32),
    .Y(_0306_));
 sky130_fd_sc_hd__inv_2 _6566_ (.A(net955),
    .Y(_0307_));
 sky130_fd_sc_hd__inv_2 _6567_ (.A(net956),
    .Y(_0308_));
 sky130_fd_sc_hd__inv_2 _6568_ (.A(net956),
    .Y(_0309_));
 sky130_fd_sc_hd__inv_2 _6569_ (.A(net41),
    .Y(_0310_));
 sky130_fd_sc_hd__inv_2 _6570_ (.A(net953),
    .Y(_0311_));
 sky130_fd_sc_hd__inv_2 _6571_ (.A(net956),
    .Y(_0312_));
 ...
 sky130_fd_sc_hd__inv_2 _6576_ (.A(net44),
    .Y(_0317_));
 sky130_fd_sc_hd__inv_2 _6577_ (.A(net951),
    .Y(_0318_));
 ...
 sky130_fd_sc_hd__inv_2 _6582_ (.A(net64),
    .Y(_0323_));
 sky130_fd_sc_hd__inv_2 _6583_ (.A(net950),
    .Y(_0324_));
 ...
 sky130_fd_sc_hd__inv_2 _6586_ (.A(net62),
    .Y(_0327_));
 sky130_fd_sc_hd__inv_2 _6587_ (.A(net950),
    .Y(_0328_));
 sky130_fd_sc_hd__inv_2 _6588_ (.A(net950),
    .Y(_0329_));
 sky130_fd_sc_hd__inv_2 _6589_ (.A(net950),
    .Y(_0330_));
 ...
 sky130_fd_sc_hd__inv_2 _6609_ (.A(net59),
    .Y(_0350_));
 sky130_fd_sc_hd__inv_2 _6610_ (.A(net951),
    .Y(_0351_));
 ...
 sky130_fd_sc_hd__inv_2 _6620_ (.A(net70),
    .Y(_0361_));
 sky130_fd_sc_hd__inv_2 _6621_ (.A(net950),
    .Y(_0362_));
 ...
 sky130_fd_sc_hd__inv_2 _6645_ (.A(net57),
    .Y(_0386_));
 sky130_fd_sc_hd__inv_2 _6646_ (.A(net57),
    .Y(_0387_));
 sky130_fd_sc_hd__inv_2 _6647_ (.A(net952),
    .Y(_0388_));
 ...
 sky130_fd_sc_hd__inv_2 _6652_ (.A(net56),
    .Y(_0393_));
 sky130_fd_sc_hd__inv_2 _6653_ (.A(net952),
    .Y(_0394_));
 ...
 sky130_fd_sc_hd__buf_2 _7412_ (.A(net775),
    .X(net891));
 sky130_fd_sc_hd__buf_2 fanout17 (.A(net18),
    .X(net17));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout18 (.A(net47),
    .X(net18));
 ...
 sky130_fd_sc_hd__buf_2 fanout21 (.A(net22),
    .X(net21));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout22 (.A(net47),
    .X(net22));
 ...
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout38 (.A(net47),
    .X(net38));
 sky130_fd_sc_hd__buf_2 fanout39 (.A(net953),
    .X(net39));
 ...
 sky130_fd_sc_hd__buf_2 fanout49 (.A(net50),
    .X(net49));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout50 (.A(net957),
    .X(net50));
 sky130_fd_sc_hd__buf_2 fanout51 (.A(net52),
    .X(net51));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout52 (.A(net957),
    .X(net52));
 sky130_fd_sc_hd__buf_2 fanout53 (.A(net57),
    .X(net53));
 sky130_fd_sc_hd__buf_2 fanout54 (.A(net57),
    .X(net54));
 sky130_fd_sc_hd__buf_2 fanout55 (.A(net952),
    .X(net55));
 sky130_fd_sc_hd__buf_2 fanout56 (.A(net952),
    .X(net56));
 ...
 sky130_fd_sc_hd__buf_2 fanout72 (.A(net73),
    .X(net72));
 sky130_fd_sc_hd__clkdlybuf4s25_1 fanout73 (.A(net957),
    .X(net73));
 sky130_fd_sc_hd__buf_1 fanout74 (.A(reset),
    .X(net74));
 sky130_fd_sc_hd__clkdlybuf4s25_1 max_cap932 (.A(net933),
    .X(net932));
 sky130_fd_sc_hd__buf_1 max_cap933 (.A(_2790_),
    .X(net933));
 sky130_fd_sc_hd__clkbuf_2 max_cap934 (.A(_2265_),
    .X(net934));
 sky130_fd_sc_hd__clkbuf_4 max_cap935 (.A(_1937_),
    .X(net935));
 sky130_fd_sc_hd__clkbuf_2 max_cap938 (.A(_2143_),
    .X(net938));
 sky130_fd_sc_hd__clkdlybuf4s25_1 max_cap939 (.A(net940),
    .X(net939));
 sky130_fd_sc_hd__clkdlybuf4s25_1 max_cap940 (.A(_2141_),
    .X(net940));
 sky130_fd_sc_hd__clkbuf_2 max_cap944 (.A(_1331_),
    .X(net944));
 sky130_fd_sc_hd__clkbuf_4 max_cap945 (.A(_1321_),
    .X(net945));
 sky130_fd_sc_hd__buf_2 max_cap946 (.A(net71),
    .X(net946));
 sky130_fd_sc_hd__buf_2 max_cap947 (.A(_1326_),
    .X(net947));
 sky130_fd_sc_hd__buf_2 max_cap949 (.A(net69),
    .X(net949));
 sky130_fd_sc_hd__buf_2 max_cap950 (.A(net63),
    .X(net950));
 sky130_fd_sc_hd__buf_4 max_cap952 (.A(net57),
    .X(net952));
 sky130_fd_sc_hd__buf_2 max_cap953 (.A(net41),
    .X(net953));
 sky130_fd_sc_hd__buf_2 max_cap954 (.A(net37),
    .X(net954));
 sky130_fd_sc_hd__buf_2 max_cap955 (.A(net32),
    .X(net955));
 sky130_fd_sc_hd__buf_2 max_cap956 (.A(net31),
    .X(net956));
 sky130_fd_sc_hd__clkdlybuf4s25_1 output840 (.A(net840),
    .X(alu_result_out[0]));
 sky130_fd_sc_hd__clkdlybuf4s25_1 output841 (.A(net841),
    .X(alu_result_out[10]));
 sky130_fd_sc_hd__clkdlybuf4s25_1 output842 (.A(net842),
    .X(alu_result_out[11]));
 sky130_fd_sc_hd__clkdlybuf4s25_1 output843 (.A(net843),
    .X(alu_result_out[12]));
 sky130_fd_sc_hd__clkdlybuf4s25_1 output844 (.A(net844),
    .X(alu_result_out[13]));
 sky130_fd_sc_hd__clkdlybuf4s25_1 output845 (.A(net845),
    .X(alu_result_out[14]));
 sky130_fd_sc_hd__clkdlybuf4s25_1 output846 (.A(net846),
    .X(alu_result_out[15]));
 sky130_fd_sc_hd__clkdlybuf4s25_1 output847 (.A(net847),
    .X(alu_result_out[16]));
 sky130_fd_sc_hd__clkdlybuf4s25_1 output848 (.A(net848),
    .X(alu_result_out[17]));
 sky130_fd_sc_hd__clkdlybuf4s25_1 output849 (.A(net849),
    .X(alu_result_out[18]));
 sky130_fd_sc_hd__clkdlybuf4s25_1 output850 (.A(net646),
    .X(net850));
 sky130_fd_sc_hd__clkdlybuf4s25_1 output851 (.A(net851),
    .X(alu_result_out[1]));
 sky130_fd_sc_hd__clkdlybuf4s25_1 output852 (.A(net647),
    .X(net852));
 sky130_fd_sc_hd__clkdlybuf4s25_1 output853 (.A(net853),
    .X(alu_result_out[21]));
 sky130_fd_sc_hd__clkdlybuf4s25_1 output854 (.A(net854),
    .X(alu_result_out[22]));
 sky130_fd_sc_hd__clkdlybuf4s25_1 output855 (.A(net855),
    .X(alu_result_out[23]));
 sky130_fd_sc_hd__clkdlybuf4s25_1 output856 (.A(net856),
    .X(alu_result_out[24]));
 sky130_fd_sc_hd__clkdlybuf4s25_1 output857 (.A(net857),
    .X(alu_result_out[25]));
 sky130_fd_sc_hd__clkdlybuf4s25_1 output858 (.A(net858),
    .X(alu_result_out[26]));
 sky130_fd_sc_hd__clkdlybuf4s25_1 output859 (.A(net859),
    .X(alu_result_out[27]));
 sky130_fd_sc_hd__clkdlybuf4s25_1 output860 (.A(net860),
    .X(alu_result_out[28]));
 sky130_fd_sc_hd__clkdlybuf4s25_1 output861 (.A(net861),
    .X(alu_result_out[29]));
 sky130_fd_sc_hd__clkdlybuf4s25_1 output862 (.A(net862),
    .X(alu_result_out[2]));
 sky130_fd_sc_hd__clkdlybuf4s25_1 output863 (.A(net863),
    .X(alu_result_out[30]));
 sky130_fd_sc_hd__clkdlybuf4s25_1 output864 (.A(net864),
    .X(alu_result_out[31]));
 sky130_fd_sc_hd__clkdlybuf4s25_1 output865 (.A(net865),
    .X(alu_result_out[3]));
 sky130_fd_sc_hd__clkdlybuf4s25_1 output866 (.A(net866),
    .X(alu_result_out[4]));
 sky130_fd_sc_hd__clkdlybuf4s25_1 output867 (.A(net867),
    .X(alu_result_out[5]));
 sky130_fd_sc_hd__clkdlybuf4s25_1 output868 (.A(net868),
    .X(alu_result_out[6]));
 sky130_fd_sc_hd__clkdlybuf4s25_1 output869 (.A(net648),
    .X(net869));
 sky130_fd_sc_hd__clkdlybuf4s25_1 output870 (.A(net870),
    .X(alu_result_out[8]));
 sky130_fd_sc_hd__clkdlybuf4s25_1 output871 (.A(net871),
    .X(alu_result_out[9]));
 sky130_fd_sc_hd__clkdlybuf4s25_1 output872 (.A(net872),
    .X(instruction_out[10]));
 sky130_fd_sc_hd__clkdlybuf4s25_1 output873 (.A(net873),
    .X(instruction_out[11]));
 sky130_fd_sc_hd__clkdlybuf4s25_1 output874 (.A(net874),
    .X(instruction_out[12]));
 sky130_fd_sc_hd__clkdlybuf4s25_1 output875 (.A(net875),
    .X(instruction_out[13]));
 sky130_fd_sc_hd__clkdlybuf4s25_1 output876 (.A(net876),
    .X(instruction_out[14]));
 sky130_fd_sc_hd__clkdlybuf4s25_1 output877 (.A(net877),
    .X(instruction_out[15]));
 sky130_fd_sc_hd__clkdlybuf4s25_1 output878 (.A(net778),
    .X(net878));
 sky130_fd_sc_hd__clkdlybuf4s25_1 output879 (.A(net879),
    .X(instruction_out[17]));
 sky130_fd_sc_hd__clkdlybuf4s25_1 output880 (.A(net576),
    .X(net880));
 sky130_fd_sc_hd__clkdlybuf4s25_1 output881 (.A(net881),
    .X(instruction_out[20]));
 sky130_fd_sc_hd__clkdlybuf4s25_1 output882 (.A(net882),
    .X(instruction_out[21]));
 sky130_fd_sc_hd__clkdlybuf4s25_1 output883 (.A(net883),
    .X(instruction_out[22]));
 sky130_fd_sc_hd__clkdlybuf4s25_1 output884 (.A(net884),
    .X(instruction_out[23]));
 sky130_fd_sc_hd__clkdlybuf4s25_1 output885 (.A(net796),
    .X(net885));
 sky130_fd_sc_hd__clkdlybuf4s25_1 output886 (.A(net886),
    .X(instruction_out[25]));
 sky130_fd_sc_hd__clkdlybuf4s25_1 output887 (.A(net887),
    .X(instruction_out[26]));
 sky130_fd_sc_hd__clkdlybuf4s25_1 output888 (.A(net888),
    .X(instruction_out[27]));
 sky130_fd_sc_hd__clkdlybuf4s25_1 output889 (.A(net889),
    .X(instruction_out[28]));
 sky130_fd_sc_hd__clkdlybuf4s25_1 output890 (.A(net890),
    .X(instruction_out[2]));
 sky130_fd_sc_hd__clkdlybuf4s25_1 output891 (.A(net891),
    .X(instruction_out[30]));
 sky130_fd_sc_hd__clkdlybuf4s25_1 output892 (.A(net780),
    .X(net892));
 sky130_fd_sc_hd__clkdlybuf4s25_1 output893 (.A(net893),
    .X(instruction_out[4]));
 sky130_fd_sc_hd__clkdlybuf4s25_1 output894 (.A(net894),
    .X(instruction_out[5]));
 sky130_fd_sc_hd__clkdlybuf4s25_1 output895 (.A(net771),
    .X(net895));
 sky130_fd_sc_hd__clkdlybuf4s25_1 output896 (.A(net896),
    .X(instruction_out[7]));
 sky130_fd_sc_hd__clkdlybuf4s25_1 output897 (.A(net897),
    .X(instruction_out[8]));
 sky130_fd_sc_hd__clkdlybuf4s25_1 output898 (.A(net898),
    .X(instruction_out[9]));
 sky130_fd_sc_hd__clkdlybuf4s25_1 output899 (.A(net899),
    .X(pc_out[0]));
 sky130_fd_sc_hd__clkdlybuf4s25_1 output900 (.A(net900),
    .X(pc_out[10]));
 sky130_fd_sc_hd__clkdlybuf4s25_1 output901 (.A(net901),
    .X(pc_out[11]));
 sky130_fd_sc_hd__clkdlybuf4s25_1 output902 (.A(net902),
    .X(pc_out[12]));
 sky130_fd_sc_hd__clkdlybuf4s25_1 output903 (.A(net903),
    .X(pc_out[13]));
 sky130_fd_sc_hd__clkdlybuf4s25_1 output904 (.A(net904),
    .X(pc_out[14]));
 sky130_fd_sc_hd__clkdlybuf4s25_1 output905 (.A(net905),
    .X(pc_out[15]));
 sky130_fd_sc_hd__clkdlybuf4s25_1 output906 (.A(net906),
    .X(pc_out[16]));
 sky130_fd_sc_hd__clkdlybuf4s25_1 output907 (.A(net907),
    .X(pc_out[17]));
 sky130_fd_sc_hd__clkdlybuf4s25_1 output908 (.A(net908),
    .X(pc_out[18]));
 sky130_fd_sc_hd__clkdlybuf4s25_1 output909 (.A(net909),
    .X(pc_out[19]));
 sky130_fd_sc_hd__clkdlybuf4s25_1 output910 (.A(net910),
    .X(pc_out[1]));
 sky130_fd_sc_hd__clkdlybuf4s25_1 output911 (.A(net911),
    .X(pc_out[20]));
 sky130_fd_sc_hd__clkdlybuf4s25_1 output912 (.A(net912),
    .X(pc_out[21]));
 sky130_fd_sc_hd__clkdlybuf4s25_1 output913 (.A(net913),
    .X(pc_out[22]));
 sky130_fd_sc_hd__clkdlybuf4s25_1 output914 (.A(net914),
    .X(pc_out[23]));
 sky130_fd_sc_hd__clkdlybuf4s25_1 output915 (.A(net915),
    .X(pc_out[24]));
 sky130_fd_sc_hd__clkdlybuf4s25_1 output916 (.A(net916),
    .X(pc_out[25]));
 sky130_fd_sc_hd__clkdlybuf4s25_1 output917 (.A(net917),
    .X(pc_out[26]));
 sky130_fd_sc_hd__clkdlybuf4s25_1 output918 (.A(net918),
    .X(pc_out[27]));
 sky130_fd_sc_hd__clkdlybuf4s25_1 output919 (.A(net919),
    .X(pc_out[28]));
 sky130_fd_sc_hd__clkdlybuf4s25_1 output920 (.A(net920),
    .X(pc_out[29]));
 sky130_fd_sc_hd__clkdlybuf4s25_1 output921 (.A(net838),
    .X(net921));
 sky130_fd_sc_hd__clkdlybuf4s25_1 output922 (.A(net922),
    .X(pc_out[30]));
 sky130_fd_sc_hd__clkdlybuf4s25_1 output923 (.A(net923),
    .X(pc_out[31]));
 sky130_fd_sc_hd__clkdlybuf4s25_1 output924 (.A(net835),
    .X(net924));
 sky130_fd_sc_hd__clkdlybuf4s25_1 output925 (.A(net834),
    .X(net925));
 sky130_fd_sc_hd__clkdlybuf4s25_1 output926 (.A(net831),
    .X(net926));
 sky130_fd_sc_hd__clkdlybuf4s25_1 output927 (.A(net830),
    .X(net927));
 sky130_fd_sc_hd__clkdlybuf4s25_1 output928 (.A(net928),
    .X(pc_out[7]));
 sky130_fd_sc_hd__clkdlybuf4s25_1 output929 (.A(net929),
    .X(pc_out[8]));
 sky130_fd_sc_hd__clkdlybuf4s25_1 output930 (.A(net930),
    .X(pc_out[9]));
 sky130_fd_sc_hd__buf_2 place204 (.A(net204),
    .X(net886));
 sky130_fd_sc_hd__buf_2 place646 (.A(net75),
    .X(net646));
 sky130_fd_sc_hd__buf_2 place647 (.A(net1),
    .X(net647));
 sky130_fd_sc_hd__buf_2 place648 (.A(net77),
    .X(net648));
 sky130_fd_sc_hd__buf_2 place649 (.A(net650),
    .X(net649));
 sky130_fd_sc_hd__buf_2 place650 (.A(_1563_),
    .X(net650));
 sky130_fd_sc_hd__buf_2 place651 (.A(net653),
    .X(net651));
 sky130_fd_sc_hd__buf_2 place652 (.A(net653),
    .X(net652));
 sky130_fd_sc_hd__buf_2 place653 (.A(net654),
    .X(net653));
 sky130_fd_sc_hd__buf_2 place654 (.A(_1598_),
    .X(net654));
 sky130_fd_sc_hd__buf_2 place655 (.A(net656),
    .X(net655));
 sky130_fd_sc_hd__buf_2 place656 (.A(net657),
    .X(net656));
 sky130_fd_sc_hd__buf_2 place657 (.A(_1598_),
    .X(net657));
 sky130_fd_sc_hd__buf_2 place658 (.A(_1598_),
    .X(net658));
 sky130_fd_sc_hd__buf_2 place659 (.A(net660),
    .X(net659));
 sky130_fd_sc_hd__buf_2 place660 (.A(_1594_),
    .X(net660));
 sky130_fd_sc_hd__buf_2 place661 (.A(net662),
    .X(net661));
 sky130_fd_sc_hd__buf_2 place662 (.A(_1594_),
    .X(net662));
 sky130_fd_sc_hd__buf_2 place663 (.A(net664),
    .X(net663));
 sky130_fd_sc_hd__buf_2 place664 (.A(net665),
    .X(net664));
 sky130_fd_sc_hd__buf_2 place665 (.A(_1594_),
    .X(net665));
 sky130_fd_sc_hd__buf_2 place666 (.A(_1589_),
    .X(net666));
 sky130_fd_sc_hd__buf_2 place667 (.A(net668),
    .X(net667));
 sky130_fd_sc_hd__buf_2 place668 (.A(net671),
    .X(net668));
 sky130_fd_sc_hd__buf_2 place669 (.A(net670),
    .X(net669));
 sky130_fd_sc_hd__buf_2 place670 (.A(net671),
    .X(net670));
 sky130_fd_sc_hd__buf_2 place671 (.A(_1589_),
    .X(net671));
 sky130_fd_sc_hd__buf_2 place672 (.A(net673),
    .X(net672));
 sky130_fd_sc_hd__buf_2 place673 (.A(_1589_),
    .X(net673));
 sky130_fd_sc_hd__buf_2 place674 (.A(_1584_),
    .X(net674));
 sky130_fd_sc_hd__buf_2 place675 (.A(_1584_),
    .X(net675));
 sky130_fd_sc_hd__buf_2 place676 (.A(_1584_),
    .X(net676));
 sky130_fd_sc_hd__buf_2 place677 (.A(net678),
    .X(net677));
 sky130_fd_sc_hd__buf_2 place678 (.A(net679),
    .X(net678));
 sky130_fd_sc_hd__buf_2 place679 (.A(net680),
    .X(net679));
 sky130_fd_sc_hd__buf_2 place680 (.A(_1584_),
    .X(net680));
 sky130_fd_sc_hd__buf_2 place681 (.A(net865),
    .X(net681));
 sky130_fd_sc_hd__buf_2 place682 (.A(net862),
    .X(net682));
 sky130_fd_sc_hd__buf_2 place683 (.A(_2054_),
    .X(net683));
 sky130_fd_sc_hd__buf_2 place684 (.A(_2183_),
    .X(net684));
 sky130_fd_sc_hd__buf_2 place685 (.A(_1558_),
    .X(net685));
 sky130_fd_sc_hd__buf_2 place686 (.A(net687),
    .X(net686));
 sky130_fd_sc_hd__buf_2 place687 (.A(_1541_),
    .X(net687));
 sky130_fd_sc_hd__buf_2 place688 (.A(_2150_),
    .X(net688));
 sky130_fd_sc_hd__buf_2 place689 (.A(_1554_),
    .X(net689));
 sky130_fd_sc_hd__buf_2 place690 (.A(_1522_),
    .X(net690));
 sky130_fd_sc_hd__buf_2 place691 (.A(_1486_),
    .X(net691));
 sky130_fd_sc_hd__buf_2 place692 (.A(_1460_),
    .X(net692));
 sky130_fd_sc_hd__buf_2 place693 (.A(net695),
    .X(net693));
 sky130_fd_sc_hd__buf_2 place694 (.A(net695),
    .X(net694));
 sky130_fd_sc_hd__buf_2 place695 (.A(_2371_),
    .X(net695));
 sky130_fd_sc_hd__buf_2 place696 (.A(_1512_),
    .X(net696));
 sky130_fd_sc_hd__buf_2 place697 (.A(_1472_),
    .X(net697));
 sky130_fd_sc_hd__buf_2 place698 (.A(net699),
    .X(net698));
 sky130_fd_sc_hd__buf_2 place699 (.A(_1363_),
    .X(net699));
 sky130_fd_sc_hd__buf_2 place700 (.A(net704),
    .X(net700));
 sky130_fd_sc_hd__buf_2 place701 (.A(net702),
    .X(net701));
 sky130_fd_sc_hd__buf_2 place702 (.A(net703),
    .X(net702));
 sky130_fd_sc_hd__buf_2 place703 (.A(net704),
    .X(net703));
 sky130_fd_sc_hd__buf_2 place704 (.A(_1304_),
    .X(net704));
 sky130_fd_sc_hd__buf_2 place705 (.A(net706),
    .X(net705));
 sky130_fd_sc_hd__buf_2 place706 (.A(net707),
    .X(net706));
 sky130_fd_sc_hd__buf_2 place707 (.A(_2985_),
    .X(net707));
 sky130_fd_sc_hd__buf_2 place708 (.A(net710),
    .X(net708));
 sky130_fd_sc_hd__buf_2 place709 (.A(net710),
    .X(net709));
 sky130_fd_sc_hd__buf_2 place710 (.A(_2917_),
    .X(net710));
 sky130_fd_sc_hd__buf_2 place711 (.A(_2882_),
    .X(net711));
 sky130_fd_sc_hd__buf_2 place712 (.A(_2882_),
    .X(net712));
 sky130_fd_sc_hd__buf_2 place713 (.A(_2882_),
    .X(net713));
 sky130_fd_sc_hd__buf_2 place714 (.A(net715),
    .X(net714));
 sky130_fd_sc_hd__buf_2 place715 (.A(net716),
    .X(net715));
 sky130_fd_sc_hd__buf_2 place716 (.A(_1389_),
    .X(net716));
 sky130_fd_sc_hd__buf_2 place717 (.A(net718),
    .X(net717));
 sky130_fd_sc_hd__buf_2 place718 (.A(net719),
    .X(net718));
 sky130_fd_sc_hd__buf_2 place719 (.A(net720),
    .X(net719));
 sky130_fd_sc_hd__buf_2 place720 (.A(_1361_),
    .X(net720));
 sky130_fd_sc_hd__buf_2 place721 (.A(net722),
    .X(net721));
 sky130_fd_sc_hd__buf_2 place722 (.A(net723),
    .X(net722));
 sky130_fd_sc_hd__buf_2 place723 (.A(_1350_),
    .X(net723));
 sky130_fd_sc_hd__buf_2 place724 (.A(net725),
    .X(net724));
 sky130_fd_sc_hd__buf_2 place725 (.A(net726),
    .X(net725));
 sky130_fd_sc_hd__buf_2 place726 (.A(_1348_),
    .X(net726));
 sky130_fd_sc_hd__buf_2 place727 (.A(net728),
    .X(net727));
 sky130_fd_sc_hd__buf_2 place728 (.A(net729),
    .X(net728));
 sky130_fd_sc_hd__buf_2 place729 (.A(_1320_),
    .X(net729));
 sky130_fd_sc_hd__buf_2 place730 (.A(net733),
    .X(net730));
 sky130_fd_sc_hd__buf_2 place731 (.A(net733),
    .X(net731));
 sky130_fd_sc_hd__buf_2 place732 (.A(net733),
    .X(net732));
 sky130_fd_sc_hd__buf_2 place733 (.A(net735),
    .X(net733));
 sky130_fd_sc_hd__buf_2 place734 (.A(net735),
    .X(net734));
 sky130_fd_sc_hd__buf_2 place735 (.A(_1287_),
    .X(net735));
 sky130_fd_sc_hd__buf_2 place736 (.A(_1283_),
    .X(net736));
 sky130_fd_sc_hd__buf_2 place737 (.A(net738),
    .X(net737));
 sky130_fd_sc_hd__buf_2 place738 (.A(_1283_),
    .X(net738));
 sky130_fd_sc_hd__buf_2 place739 (.A(_2408_),
    .X(net739));
 sky130_fd_sc_hd__buf_2 place740 (.A(net741),
    .X(net740));
 sky130_fd_sc_hd__buf_2 place741 (.A(_1463_),
    .X(net741));
 sky130_fd_sc_hd__buf_2 place742 (.A(_1459_),
    .X(net742));
 sky130_fd_sc_hd__buf_2 place743 (.A(_1369_),
    .X(net743));
 sky130_fd_sc_hd__buf_2 place744 (.A(net745),
    .X(net744));
 sky130_fd_sc_hd__buf_2 place745 (.A(_1369_),
    .X(net745));
 sky130_fd_sc_hd__buf_2 place746 (.A(net747),
    .X(net746));
 sky130_fd_sc_hd__buf_2 place747 (.A(net748),
    .X(net747));
 sky130_fd_sc_hd__buf_2 place748 (.A(_1357_),
    .X(net748));
 sky130_fd_sc_hd__buf_2 place749 (.A(net750),
    .X(net749));
 sky130_fd_sc_hd__buf_2 place750 (.A(net755),
    .X(net750));
 sky130_fd_sc_hd__buf_2 place751 (.A(net752),
    .X(net751));
 sky130_fd_sc_hd__buf_2 place752 (.A(net753),
    .X(net752));
 sky130_fd_sc_hd__buf_2 place753 (.A(net754),
    .X(net753));
 sky130_fd_sc_hd__buf_2 place754 (.A(net755),
    .X(net754));
 sky130_fd_sc_hd__buf_2 place755 (.A(net756),
    .X(net755));
 sky130_fd_sc_hd__buf_2 place756 (.A(_1355_),
    .X(net756));
 sky130_fd_sc_hd__buf_2 place757 (.A(net758),
    .X(net757));
 sky130_fd_sc_hd__buf_2 place758 (.A(net759),
    .X(net758));
 sky130_fd_sc_hd__buf_2 place759 (.A(_1337_),
    .X(net759));
 sky130_fd_sc_hd__buf_2 place760 (.A(_1335_),
    .X(net760));
 sky130_fd_sc_hd__buf_2 place761 (.A(net762),
    .X(net761));
 sky130_fd_sc_hd__buf_2 place762 (.A(net763),
    .X(net762));
 sky130_fd_sc_hd__buf_2 place763 (.A(net944),
    .X(net763));
 sky130_fd_sc_hd__buf_2 place764 (.A(net765),
    .X(net764));
 sky130_fd_sc_hd__buf_2 place765 (.A(net766),
    .X(net765));
 sky130_fd_sc_hd__buf_2 place766 (.A(net945),
    .X(net766));
 sky130_fd_sc_hd__buf_2 place767 (.A(net767),
    .X(net890));
 sky130_fd_sc_hd__buf_2 place768 (.A(net769),
    .X(net768));
 sky130_fd_sc_hd__buf_2 place769 (.A(net770),
    .X(net769));
 sky130_fd_sc_hd__buf_2 place770 (.A(_1312_),
    .X(net770));
 sky130_fd_sc_hd__buf_2 place771 (.A(net191),
    .X(net771));
 sky130_fd_sc_hd__buf_2 place772 (.A(net773),
    .X(net772));
 sky130_fd_sc_hd__buf_2 place773 (.A(net774),
    .X(net773));
 sky130_fd_sc_hd__buf_2 place774 (.A(net775),
    .X(net774));
 sky130_fd_sc_hd__buf_2 place775 (.A(_2950_),
    .X(net775));
 sky130_fd_sc_hd__buf_2 place776 (.A(net777),
    .X(net776));
 sky130_fd_sc_hd__buf_2 place777 (.A(net889),
    .X(net777));
 sky130_fd_sc_hd__buf_2 place778 (.A(net238),
    .X(net778));
 sky130_fd_sc_hd__buf_2 place779 (.A(net781),
    .X(net779));
 sky130_fd_sc_hd__buf_2 place780 (.A(net781),
    .X(net780));
 sky130_fd_sc_hd__buf_2 place781 (.A(_1289_),
    .X(net781));
 sky130_fd_sc_hd__buf_2 place782 (.A(net782),
    .X(net888));
 sky130_fd_sc_hd__buf_2 place783 (.A(_2335_),
    .X(net783));
 sky130_fd_sc_hd__buf_2 place784 (.A(_2335_),
    .X(net784));
 sky130_fd_sc_hd__buf_2 place785 (.A(net786),
    .X(net785));
 sky130_fd_sc_hd__buf_2 place786 (.A(_2335_),
    .X(net786));
 sky130_fd_sc_hd__buf_2 place787 (.A(_1345_),
    .X(net787));
 sky130_fd_sc_hd__buf_2 place788 (.A(net789),
    .X(net788));
 sky130_fd_sc_hd__buf_2 place789 (.A(net790),
    .X(net789));
 sky130_fd_sc_hd__buf_2 place790 (.A(net795),
    .X(net790));
 sky130_fd_sc_hd__buf_2 place791 (.A(net793),
    .X(net791));
 sky130_fd_sc_hd__buf_2 place792 (.A(net793),
    .X(net792));
 sky130_fd_sc_hd__buf_2 place793 (.A(net794),
    .X(net793));
 sky130_fd_sc_hd__buf_2 place794 (.A(net795),
    .X(net794));
 sky130_fd_sc_hd__buf_2 place795 (.A(net947),
    .X(net795));
 sky130_fd_sc_hd__buf_2 place796 (.A(net797),
    .X(net796));
 sky130_fd_sc_hd__buf_2 place797 (.A(net947),
    .X(net797));
 sky130_fd_sc_hd__buf_2 place798 (.A(net803),
    .X(net798));
 sky130_fd_sc_hd__buf_2 place799 (.A(net800),
    .X(net799));
 sky130_fd_sc_hd__buf_2 place800 (.A(net801),
    .X(net800));
 sky130_fd_sc_hd__buf_2 place801 (.A(net802),
    .X(net801));
 sky130_fd_sc_hd__buf_2 place802 (.A(net803),
    .X(net802));
 sky130_fd_sc_hd__buf_2 place803 (.A(_1323_),
    .X(net803));
 sky130_fd_sc_hd__buf_2 place804 (.A(net805),
    .X(net804));
 sky130_fd_sc_hd__buf_2 place805 (.A(_1323_),
    .X(net805));
 sky130_fd_sc_hd__buf_2 place806 (.A(net818),
    .X(net806));
 sky130_fd_sc_hd__buf_2 place807 (.A(net817),
    .X(net807));
 sky130_fd_sc_hd__buf_2 place808 (.A(net809),
    .X(net808));
 sky130_fd_sc_hd__buf_2 place809 (.A(net817),
    .X(net809));
 sky130_fd_sc_hd__buf_2 place810 (.A(net815),
    .X(net810));
 sky130_fd_sc_hd__buf_2 place811 (.A(net813),
    .X(net811));
 sky130_fd_sc_hd__buf_2 place812 (.A(net813),
    .X(net812));
 sky130_fd_sc_hd__buf_2 place813 (.A(net814),
    .X(net813));
 sky130_fd_sc_hd__buf_2 place814 (.A(net815),
    .X(net814));
 sky130_fd_sc_hd__buf_2 place815 (.A(net816),
    .X(net815));
 sky130_fd_sc_hd__buf_2 place816 (.A(net817),
    .X(net816));
 sky130_fd_sc_hd__buf_2 place817 (.A(net818),
    .X(net817));
 sky130_fd_sc_hd__buf_2 place818 (.A(_1316_),
    .X(net818));
 sky130_fd_sc_hd__buf_2 place819 (.A(_1292_),
    .X(net819));
 sky130_fd_sc_hd__buf_2 place820 (.A(net821),
    .X(net820));
 sky130_fd_sc_hd__buf_2 place821 (.A(_1281_),
    .X(net821));
 sky130_fd_sc_hd__buf_2 place822 (.A(net823),
    .X(net822));
 sky130_fd_sc_hd__buf_2 place823 (.A(_1264_),
    .X(net823));
 sky130_fd_sc_hd__buf_2 place824 (.A(net825),
    .X(net824));
 sky130_fd_sc_hd__buf_2 place825 (.A(net826),
    .X(net825));
 sky130_fd_sc_hd__buf_2 place826 (.A(net827),
    .X(net826));
 sky130_fd_sc_hd__buf_2 place827 (.A(_1266_),
    .X(net827));
 sky130_fd_sc_hd__buf_2 place828 (.A(net910),
    .X(net828));
 sky130_fd_sc_hd__buf_2 place829 (.A(net256),
    .X(net829));
 sky130_fd_sc_hd__buf_2 place830 (.A(net256),
    .X(net830));
 sky130_fd_sc_hd__buf_4 place831 (.A(net832),
    .X(net831));
 sky130_fd_sc_hd__buf_2 place832 (.A(net259),
    .X(net832));
 sky130_fd_sc_hd__buf_2 place833 (.A(net10),
    .X(net833));
 sky130_fd_sc_hd__buf_2 place834 (.A(net10),
    .X(net834));
 sky130_fd_sc_hd__buf_2 place835 (.A(net454),
    .X(net835));
 sky130_fd_sc_hd__buf_2 place836 (.A(net454),
    .X(net836));
 sky130_fd_sc_hd__buf_2 place837 (.A(net454),
    .X(net837));
 sky130_fd_sc_hd__buf_4 place838 (.A(net456),
    .X(net838));
 sky130_fd_sc_hd__buf_2 place839 (.A(net456),
    .X(net839));
 sky130_fd_sc_hd__conb_1 single_cycle_cpu (.LO(net));
 sky130_fd_sc_hd__conb_1 single_cycle_cpu_958 (.LO(net958));
 sky130_fd_sc_hd__conb_1 single_cycle_cpu_959 (.LO(net959));
 sky130_fd_sc_hd__conb_1 single_cycle_cpu_960 (.HI(net960));
 sky130_fd_sc_hd__conb_1 single_cycle_cpu_961 (.HI(net961));
 sky130_fd_sc_hd__clkbuf_2 wire931 (.A(_1672_),
    .X(net931));
 sky130_fd_sc_hd__clkdlybuf4s25_1 wire936 (.A(net937),
    .X(net936));
 sky130_fd_sc_hd__clkdlybuf4s25_1 wire937 (.A(_2421_),
    .X(net937));
 sky130_fd_sc_hd__buf_1 wire941 (.A(_1527_),
    .X(net941));
 sky130_fd_sc_hd__clkbuf_2 wire942 (.A(_1415_),
    .X(net942));
 sky130_fd_sc_hd__buf_2 wire943 (.A(_1287_),
    .X(net943));
 sky130_fd_sc_hd__clkdlybuf4s25_1 wire948 (.A(_1316_),
    .X(net948));
 sky130_fd_sc_hd__buf_2 wire951 (.A(net59),
    .X(net951));
 sky130_fd_sc_hd__clkbuf_4 wire957 (.A(net74),
    .X(net957));
 assign alu_result_out[19] = net850;
 assign alu_result_out[20] = net852;
 assign alu_result_out[7] = net869;
 assign instruction_out[0] = net960;
 assign instruction_out[16] = net878;
 assign instruction_out[18] = net880;
 assign instruction_out[19] = net;
 assign instruction_out[1] = net961;
 assign instruction_out[24] = net885;
 assign instruction_out[29] = net958;
 assign instruction_out[31] = net959;
 assign instruction_out[3] = net892;
 assign instruction_out[6] = net895;
 assign pc_out[2] = net921;
 assign pc_out[3] = net924;
 assign pc_out[4] = net925;
 assign pc_out[5] = net926;
 assign pc_out[6] = net927;
endmodule
