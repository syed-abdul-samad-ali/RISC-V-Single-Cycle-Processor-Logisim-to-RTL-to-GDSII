module single_cycle_cpu (clk,
 ...
 sky130_fd_sc_hd__conb_1 single_cycle_cpu (.VGND(VGND),
    ...
    .VPWR(VPWR),
    .LO(net));
 sky130_fd_sc_hd__conb_1 single_cycle_cpu_958 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net958));
 sky130_fd_sc_hd__conb_1 single_cycle_cpu_959 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net959));
 sky130_fd_sc_hd__conb_1 single_cycle_cpu_960 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .HI(net960));
 sky130_fd_sc_hd__conb_1 single_cycle_cpu_961 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .HI(net961));
