module single_cycle_cpu (clk,
 ...
 sky130_fd_sc_hd__conb_1 single_cycle_cpu (.VGND(VGND),
    ...
    .VPWR(VPWR),
    .LO(net));
 sky130_fd_sc_hd__conb_1 single_cycle_cpu_567 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net567));
 sky130_fd_sc_hd__conb_1 single_cycle_cpu_568 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net568));
 sky130_fd_sc_hd__conb_1 single_cycle_cpu_569 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .HI(net569));
 sky130_fd_sc_hd__conb_1 single_cycle_cpu_570 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .HI(net570));
