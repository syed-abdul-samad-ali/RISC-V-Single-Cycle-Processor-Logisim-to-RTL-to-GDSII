module single_cycle_cpu (clk,
 ...
 sky130_fd_sc_hd__conb_1 single_cycle_cpu (.VGND(VGND),
    ...
    .VPWR(VPWR),
    .LO(net));
 sky130_fd_sc_hd__conb_1 single_cycle_cpu_572 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net572));
 sky130_fd_sc_hd__conb_1 single_cycle_cpu_573 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .LO(net573));
 sky130_fd_sc_hd__conb_1 single_cycle_cpu_574 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .HI(net574));
