module single_cycle_cpu (clk,
 ...
 sky130_fd_sc_hd__buf_2 place297 (.A(net107),
    ...
    .VPWR(VPWR),
    .X(net297));
 sky130_fd_sc_hd__buf_2 place298 (.A(alu_result_out[2]),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__buf_2 place382 (.A(net383),
    ...
    .VPWR(VPWR),
    .X(net382));
 sky130_fd_sc_hd__buf_2 place383 (.A(instruction_out[28]),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__buf_2 place443 (.A(_1266_),
    ...
    .VPWR(VPWR),
    .X(net443));
 sky130_fd_sc_hd__buf_2 place444 (.A(pc_out[1]),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 assign instruction_out[16] = net426;
 assign instruction_out[18] = net412;
 assign instruction_out[24] = net393;
 assign instruction_out[25] = net391;
 assign instruction_out[6] = net378;
 assign pc_out[25] = net445;
 assign pc_out[2] = net453;
 assign pc_out[3] = net451;
 assign pc_out[4] = net449;
